...
; CHECK:       [[MERGE]]:
; CHECK-NEXT:    call void @llvm.lifetime.start.p0(i64 82, ptr [[S]])
...
; CHECK-NEXT:    call void @llvm.lifetime.end.p0(i64 82, ptr [[S]])
; CHECK-NEXT:    ret void
;
entry:
...
merge:
  call void @llvm.lifetime.start.p0(i64 82, ptr %s)
  ...
  call void @llvm.lifetime.end.p0(i64 82, ptr %s)
  ret void
}
