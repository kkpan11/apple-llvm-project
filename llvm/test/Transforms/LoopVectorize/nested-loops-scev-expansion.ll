...
; CHECK-NEXT:    [[TMP4:%.*]] = sub i32 [[SMAX2]], [[IV_1]]
...
; CHECK:       [[SCALAR_PH4]]:
; CHECK-NEXT:    [[BC_RESUME_VAL11:%.*]] = phi i32 [ [[TMP8]], %[[MIDDLE_BLOCK12]] ], [ [[IV_1]], %[[LOOP_1]] ]
; CHECK-NEXT:    br label %[[LOOP_2:.*]]
; CHECK:       [[LOOP_2]]:
; CHECK-NEXT:    [[IV_2:%.*]] = phi i32 [ [[BC_RESUME_VAL11]], %[[SCALAR_PH4]] ], [ [[IV_2_NEXT:%.*]], %[[LOOP_2]] ]
...
; CHECK-NEXT:    [[TMP14:%.*]] = sub i32 [[SMAX]], [[IV_1]]
; CHECK-NEXT:    [[TMP15:%.*]] = udiv i32 [[TMP14]], 13
; CHECK-NEXT:    [[TMP17:%.*]] = mul nuw i32 [[TMP15]], 13
...
; CHECK-NEXT:    [[TMP31:%.*]] = mul i32 [[TMP15]], -13
; CHECK-NEXT:    [[TMP23:%.*]] = sub i32 [[UMAX]], [[IV_1]]
; CHECK-NEXT:    [[TMP32:%.*]] = add i32 [[TMP23]], [[TMP31]]
; CHECK-NEXT:    [[TMP24:%.*]] = add i32 [[TMP32]], -14
; CHECK-NEXT:    [[TMP25:%.*]] = udiv i32 [[TMP24]], 13
; CHECK-NEXT:    [[TMP26:%.*]] = add nuw nsw i32 [[TMP25]], 1
