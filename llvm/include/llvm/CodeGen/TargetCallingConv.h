...
namespace ISD {
  ...
  public:
    ...
    enum Flags : uint32_t {
      ...
      SwiftCoro = 1U << 15,     ///< Swift coro parameter
      SwiftError = 1U << 16,    ///< Swift error parameter
      CFGuardTarget = 1U << 17, ///< Control Flow Guard target
      Hva = 1U << 18,           ///< HVA field
      HvaStart = 1U << 19,      ///< HVA structure start
      SecArgPass = 1U << 20,    ///< Second argument
      InConsecutiveRegsLast = 1U << 21,
      InConsecutiveRegs = 1U << 22,
      CopyElisionCandidate = 1U << 23, ///< Argument copy elision candidate
      Pointer = 1U << 24,
  ...
  public:
    ...
    bool isSwiftCoro() const { return FlagVals & SwiftCoro; }
    void setSwiftCoro() { setFlag(SwiftCoro); }
