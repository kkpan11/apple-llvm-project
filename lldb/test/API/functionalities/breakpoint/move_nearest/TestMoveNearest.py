...
class TestMoveNearest(TestBase):
    ...
    def test(self):
        ...
        lldbutil.run_break_set_by_file_and_line(
            self, "foo.h", self.line1, loc_exact=True, extra_options="-m 1"
        )
        lldbutil.run_break_set_by_file_and_line(
            self, "foo.h", self.line2, loc_exact=True, extra_options="-m 1"
        )

        self.runCmd("settings set target.move-to-nearest-code false")
        lldbutil.run_break_set_by_file_and_line(
            self, "foo.h", self.line1, loc_exact=True, extra_options="-m 0"
        )
        lldbutil.run_break_set_by_file_and_line(
            self, "foo.h", self.line2, loc_exact=True, extra_options="-m 0"
        )
        ...
        # "int"
        lldbutil.run_break_set_by_file_and_line(
            self, "main.cpp", self.line_main - 1, extra_options="-m 1"
        )
        # "main()"
        lldbutil.run_break_set_by_file_and_line(
            self, "main.cpp", self.line_main, extra_options="-m 1"
        )
        # "{"
        lldbutil.run_break_set_by_file_and_line(
            self, "main.cpp", self.line_main + 1, extra_options="-m 1"
        ...
        # "return .."
        lldbutil.run_break_set_by_file_and_line(
            self, "main.cpp", self.line_main + 2, extra_options="-m 1"
        )
