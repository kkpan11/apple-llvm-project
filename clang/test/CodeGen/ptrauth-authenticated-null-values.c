...
void f23() {
  ...
  // CHECK: 0 = getelementptr inbounds nuw %struct.S1, ptr %arrayinit.cur, i32 0, i32 0
  // CHECK: 1 = call i64 @llvm.ptrauth.sign(i64 0, i32 2, i64 0)
  // CHECK: 2 = inttoptr i64 %1 to ptr
  // CHECK: store ptr %2, ptr %0
  // CHECK: 3 = getelementptr inbounds nuw %struct.S1, ptr %arrayinit.cur, i32 0, i32 1
...
void f24() {
  ...
  // CHECK: %0 = getelementptr inbounds nuw %struct.S2, ptr %arrayinit.cur, i32 0, i32 1
  // CHECK: %1 = getelementptr inbounds nuw %struct.S1, ptr %0, i32 0, i32 0
  // CHECK: %2 = call i64 @llvm.ptrauth.sign(i64 0, i32 2, i64 0)
  // CHECK: %3 = inttoptr i64 %2 to ptr
  // CHECK: store ptr %3, ptr %1
  // CHECK: %4 = getelementptr inbounds nuw %struct.S1, ptr %0, i32 0, i32 1
...
void f26() {
  ...
  // CHECK: %0 = getelementptr inbounds nuw %struct.S3, ptr %array_authenticated_null_init.cur4, i32 0, i32 0
  // CHECK: %1 = call i64 @llvm.ptrauth.sign(i64 0, i32 2, i64 0)
  // CHECK: %2 = inttoptr i64 %1 to ptr
  // CHECK: store ptr %2, ptr %0
