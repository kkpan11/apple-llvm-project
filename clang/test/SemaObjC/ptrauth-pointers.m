...
@public
  ...
  // expected-error@-1 {{'__ptrauth' qualifier only applies to pointer types; 'id' is invalid}}
  __ptrauth(2, 1, 2) ClassPtr c;
  // expected-error@-1 {{'__ptrauth' qualifier only applies to pointer types; 'ClassPtr' (aka 'TestClass *') is invalid}}
  __ptrauth(2, 1, 2) BlockPtr d;
  // expected-error@-1 {{'__ptrauth' qualifier only applies to pointer types; 'BlockPtr' (aka 'void (^)()') is invalid}}
}
