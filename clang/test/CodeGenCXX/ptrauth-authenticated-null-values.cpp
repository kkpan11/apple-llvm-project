...
extern "C" void f8() {
  ...
  // CHECK: [[I:%.*]] = getelementptr inbounds nuw %struct.S0, ptr [[T]], i32 0, i32 0
  // CHECK: store i32 1, ptr [[I]]
  // CHECK: [[P:%.*]] = getelementptr inbounds nuw %struct.S0, ptr [[T]], i32 0, i32 1
  // CHECK: [[SIGNED:%.*]] = call i64 @llvm.ptrauth.sign(i64 0, i32 2, i64 0)
...
extern "C" void f11() {
  ...
  // CHECK: [[P:%.*]] = getelementptr inbounds nuw %struct.S1, ptr [[T]], i32 0, i32 0
  // CHECK: [[SIGN:%.*]] = call i64 @llvm.ptrauth.sign(i64 1, i32 2, i64 0)
  // CHECK: [[CAST:%.*]] = inttoptr i64 [[SIGN]] to ptr
  // CHECK: store ptr [[CAST]], ptr [[P]]
  // CHECK: [[Q:%.*]] = getelementptr inbounds nuw %struct.S1, ptr [[T]], i32 0, i32 1
...
extern "C" void f14() {
  ...
  // CHECK: [[I:%.*]] = getelementptr inbounds nuw %struct.S2, ptr [[T]], i32 0, i32 0
  // CHECK: store i32 0, ptr [[I]]
  // CHECK: [[S1:%.*]] = getelementptr inbounds nuw %struct.S2, ptr [[T]], i32 0, i32 1
  // CHECK: [[P:%.*]] = getelementptr inbounds nuw %struct.S1, ptr [[S1]], i32 0, i32 0
  ...
  // CHECK: [[Q:%.*]] = getelementptr inbounds nuw %struct.S1, ptr [[S1]], i32 0, i32 1
  // CHECK: [[ADDR_DISC:%.*]] = ptrtoint ptr [[Q]] to i64
  // CHECK: [[SIGN:%.*]] = call i64 @llvm.ptrauth.sign(i64 0, i32 2, i64 [[ADDR_DISC]])
  // CHECK: [[CAST:%.*]] = inttoptr i64 [[SIGN]] to ptr
  // CHECK: store ptr [[CAST]], ptr [[Q]]
...
extern "C" void f18() {
  ...
  // CHECK: [[A:%.*]] = getelementptr inbounds nuw %struct.Subclass, ptr %t, i32 0, i32 0
  // CHECK: [[B:%.*]] = getelementptr inbounds nuw %struct.S1, ptr [[A]], i32 0, i32 0
  // CHECK: [[C:%.*]] = call i64 @llvm.ptrauth.sign(i64 0, i32 2, i64 0)
  // CHECK: [[D:%.*]] = inttoptr i64 [[C]] to ptr
  // CHECK: store ptr [[D]], ptr [[B]]
  // CHECK: [[E:%.*]] = getelementptr inbounds nuw %struct.S1, ptr [[A]], i32 0, i32 1
...
extern "C" void f19() {
  ...
  // CHECK: %z = getelementptr inbounds nuw %struct.Subclass, ptr %t, i32 0, i32 1
...
extern "C" void f23() {
  ...
  // CHECK: %0 = getelementptr inbounds nuw %struct.S4, ptr %s, i32 0, i32 2
  // CHECK: %1 = getelementptr inbounds nuw %struct.S3, ptr %0, i32 0, i32 0
  // CHECK: %2 = call i64 @llvm.ptrauth.sign(i64 0, i32 2, i64 0)
  // CHECK: %3 = inttoptr i64 %2 to ptr
  // CHECK: store ptr %3, ptr %1
  // CHECK: %4 = getelementptr inbounds nuw %struct.S4, ptr %s, i32 0, i32 1
...
extern "C" void f26() {
  ...
  // CHECK: %field1 = getelementptr inbounds nuw %struct.S7, ptr %s, i32 0, i32 0
  // CHECK: store ptr null, ptr %field1
  // CHECK: %field2 = getelementptr inbounds nuw %struct.S7, ptr %s, i32 0, i32 1
...
// CHECK: %p = getelementptr inbounds nuw %struct.S1, ptr %this1, i32 0, i32 0
// CHECK: [[S1PTR:%.*]] = load ptr, ptr [[ADDR]]
// CHECK: %p2 = getelementptr inbounds nuw %struct.S1, ptr [[S1PTR]], i32 0, i32 0
// CHECK: [[P2:%.*]] = load ptr, ptr %p2
// CHECK: store ptr [[P2]], ptr %p
// CHECK: %q = getelementptr inbounds nuw %struct.S1, ptr %this1, i32 0, i32 1
// CHECK: [[S1PTR:%.*]] = load ptr, ptr [[ADDR]]
// CHECK: %q3 = getelementptr inbounds nuw %struct.S1, ptr [[S1PTR]], i32 0, i32 1
...
// CHECK: %1 = getelementptr inbounds nuw %struct.S1, ptr %this1, i32 0, i32 0
// CHECK: %2 = call i64 @llvm.ptrauth.sign(i64 0, i32 2, i64 0)
// CHECK: %3 = inttoptr i64 %2 to ptr
// CHECK: store ptr %3, ptr %1
// CHECK: %4 = getelementptr inbounds nuw %struct.S1, ptr %this1, i32 0, i32 1
// CHECK: %5 = ptrtoint ptr %4 to i64
// CHECK: %6 = call i64 @llvm.ptrauth.sign(i64 0, i32 2, i64 %5)
// CHECK: %7 = inttoptr i64 %6 to ptr
// CHECK: store ptr %7, ptr %4
