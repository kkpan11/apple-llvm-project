...
// CHECK-NEXT:    tail call void [[TMP0]](ptr noundef nonnull getelementptr inbounds (i8, ptr @x, i64 1), ptr noundef nonnull getelementptr inbounds (i8, ptr @x, i64 11)) #[[ATTR4:[0-9]+]]
// CHECK-NEXT:    ret void
//
void ok(void) {
