...
// UNOPT-SAME: ptr dead_on_return noundef [[PTR:%.*]], i32 noundef [[IDX:%.*]], i32 noundef [[OTHER:%.*]]) #[[ATTR0:[0-9]+]] {
// UNOPT-NEXT:  [[ENTRY:.*:]]
...
// UNOPT-TF-SAME: ptr dead_on_return noundef [[PTR:%.*]], i32 noundef [[IDX:%.*]], i32 noundef [[OTHER:%.*]]) #[[ATTR0:[0-9]+]] {
// UNOPT-TF-NEXT:  [[ENTRY:.*:]]
...
// UNOPT-TFR-SAME: ptr dead_on_return noundef [[PTR:%.*]], i32 noundef [[IDX:%.*]], i32 noundef [[OTHER:%.*]]) #[[ATTR0:[0-9]+]] {
...
// OPT-SAME: ptr dead_on_return noundef readonly captures(none) [[PTR:%.*]], i32 noundef [[IDX:%.*]], i32 noundef [[OTHER:%.*]]) local_unnamed_addr #[[ATTR0:[0-9]+]] {
// OPT-NEXT:  [[ENTRY:.*:]]
...
// OPT-NEXT:    br i1 [[TMP1]], label %[[TRAP:.*]], label %[[CONT:.*]], !prof [[PROF7:![0-9]+]], !nosanitize [[META6]]
// OPT:       [[TRAP]]:
// OPT-NEXT:    tail call void @llvm.ubsantrap(i8 0) #[[ATTR3:[0-9]+]], !nosanitize [[META6]]
...
// OPT:       [[TRAP1]]:
// OPT-NEXT:    tail call preserve_allcc void @__bounds_safety_soft_trap() #[[ATTR4:[0-9]+]], !annotation [[META11]]
...
// OPT:       [[TRAP5]]:
// OPT-NEXT:    tail call preserve_allcc void @__bounds_safety_soft_trap() #[[ATTR4]], !annotation [[META12]]
...
// OPT: [[META6]] = !{}
// OPT: [[PROF7]] = !{!"branch_weights", i32 1, i32 1048575}
