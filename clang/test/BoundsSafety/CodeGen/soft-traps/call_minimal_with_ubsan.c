...
// UNOPT:       [[TRAP]]:
// UNOPT-NEXT:    call void @llvm.ubsantrap(i8 0) #[[ATTR4:[0-9]+]], !nosanitize [[META1]]
...
// UNOPT:       [[TRAP1]]:
// UNOPT-NEXT:    call preserve_allcc void @__bounds_safety_soft_trap() #[[ATTR5:[0-9]+]], !annotation [[META3]]
...
// UNOPT:       [[TRAP3]]:
// UNOPT-NEXT:    call preserve_allcc void @__bounds_safety_soft_trap() #[[ATTR5]], !annotation [[META3]]
...
// UNOPT-TF:       [[TRAP]]:
// UNOPT-TF-NEXT:    call void @llvm.ubsantrap(i8 0) #[[ATTR4:[0-9]+]], !nosanitize [[META1]]
...
// UNOPT-TF:       [[TRAP1]]:
// UNOPT-TF-NEXT:    call preserve_allcc void @__bounds_safety_soft_trap() #[[ATTR5:[0-9]+]], !annotation [[META3]]
...
// UNOPT-TF:       [[TRAP3]]:
// UNOPT-TF-NEXT:    call preserve_allcc void @__bounds_safety_soft_trap() #[[ATTR5]], !annotation [[META3]]
...
// UNOPT-TFR:       [[TRAP]]:
// UNOPT-TFR-NEXT:    call void @ubsan_handler(i8 0) #[[ATTR3:[0-9]+]], !nosanitize [[META1]]
...
// UNOPT-TFR:       [[TRAP1]]:
// UNOPT-TFR-NEXT:    call preserve_allcc void @__bounds_safety_soft_trap() #[[ATTR4:[0-9]+]], !annotation [[META3]]
...
// UNOPT-TFR:       [[TRAP3]]:
// UNOPT-TFR-NEXT:    call preserve_allcc void @__bounds_safety_soft_trap() #[[ATTR4]], !annotation [[META3]]
...
// OPT:       [[TRAP]]:
// OPT-NEXT:    tail call void @llvm.ubsantrap(i8 0) #[[ATTR3:[0-9]+]], !nosanitize [[META5]]
...
// OPT:       [[TRAP1]]:
// OPT-NEXT:    tail call preserve_allcc void @__bounds_safety_soft_trap() #[[ATTR4:[0-9]+]], !annotation [[META10]]
...
// OPT:       [[TRAP5]]:
// OPT-NEXT:    tail call preserve_allcc void @__bounds_safety_soft_trap() #[[ATTR4]], !annotation [[META11]]
