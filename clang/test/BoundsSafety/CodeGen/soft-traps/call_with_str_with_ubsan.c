// NOTE: Assertions have been autogenerated by utils/update_cc_test_checks.py UTC_ARGS: --check-globals all --replace-value-regex "!prof ![0-9]+" --version 6
// RUN: %clang_cc1 -O0 -fbounds-safety -triple arm64-apple-ios \
...
// RUN: %clang_cc1 -O2 -fbounds-safety -triple arm64-apple-ios \
// RUN:   -emit-llvm %s -o - -fbounds-safety-soft-traps=call-with-str \
// RUN:   -fsanitize=signed-integer-overflow \
// RUN:   -fsanitize-trap=signed-integer-overflow | \
...
// UNOPT: @trap.reason = private unnamed_addr constant [41 x i8] c"indexing above upper bound in 'ptr[tmp]'\00", align 1
// UNOPT: @trap.reason.1 = private unnamed_addr constant [47 x i8] c"indexing overflows address space in 'ptr[tmp]'\00", align 1
// UNOPT: @trap.reason.2 = private unnamed_addr constant [41 x i8] c"indexing below lower bound in 'ptr[tmp]'\00", align 1
//.
...
// UNOPT-TF: @trap.reason = private unnamed_addr constant [41 x i8] c"indexing above upper bound in 'ptr[tmp]'\00", align 1
// UNOPT-TF: @trap.reason.1 = private unnamed_addr constant [47 x i8] c"indexing overflows address space in 'ptr[tmp]'\00", align 1
// UNOPT-TF: @trap.reason.2 = private unnamed_addr constant [41 x i8] c"indexing below lower bound in 'ptr[tmp]'\00", align 1
//.
...
// UNOPT-TFR: @trap.reason = private unnamed_addr constant [41 x i8] c"indexing above upper bound in 'ptr[tmp]'\00", align 1
// UNOPT-TFR: @trap.reason.1 = private unnamed_addr constant [47 x i8] c"indexing overflows address space in 'ptr[tmp]'\00", align 1
// UNOPT-TFR: @trap.reason.2 = private unnamed_addr constant [41 x i8] c"indexing below lower bound in 'ptr[tmp]'\00", align 1
//.
// OPT: @trap.reason = private unnamed_addr constant [41 x i8] c"indexing above upper bound in 'ptr[tmp]'\00", align 1
// OPT: @trap.reason.1 = private unnamed_addr constant [47 x i8] c"indexing overflows address space in 'ptr[tmp]'\00", align 1
...
// UNOPT-NEXT:    [[TMP2:%.*]] = call { i32, i1 } @llvm.sadd.with.overflow.i32(i32 [[TMP0]], i32 [[TMP1]]), !nosanitize [[META1:![0-9]+]]
// UNOPT-NEXT:    [[TMP3:%.*]] = extractvalue { i32, i1 } [[TMP2]], 0, !nosanitize [[META1]]
// UNOPT-NEXT:    [[TMP4:%.*]] = extractvalue { i32, i1 } [[TMP2]], 1, !nosanitize [[META1]]
// UNOPT-NEXT:    [[TMP5:%.*]] = xor i1 [[TMP4]], true, !nosanitize [[META1]]
// UNOPT-NEXT:    br i1 [[TMP5]], label %[[CONT:.*]], label %[[TRAP:.*]], {{!prof ![0-9]+}}, !nosanitize [[META1]]
// UNOPT:       [[TRAP]]:
// UNOPT-NEXT:    call void @llvm.ubsantrap(i8 0) #[[ATTR5:[0-9]+]], !nosanitize [[META1]]
// UNOPT-NEXT:    unreachable, !nosanitize [[META1]]
// UNOPT:       [[CONT]]:
...
// UNOPT-NEXT:    [[TMP7:%.*]] = getelementptr i32, ptr [[ARRAYIDX]], i64 1, !annotation [[META3:![0-9]+]]
// UNOPT-NEXT:    [[TMP8:%.*]] = icmp ule ptr [[TMP7]], [[WIDE_PTR_UB]], !annotation [[META3]]
// UNOPT-NEXT:    br i1 [[TMP8]], label %[[CONT2:.*]], label %[[TRAP1:.*]], {{!prof ![0-9]+}}, !annotation [[META3]]
// UNOPT:       [[TRAP1]]:
// UNOPT-NEXT:    call preserve_allcc void @__bounds_safety_soft_trap_s(ptr @trap.reason) #[[ATTR6:[0-9]+]], !annotation [[META3]]
// UNOPT-NEXT:    br label %[[CONT2]], !annotation [[META3]]
// UNOPT:       [[CONT2]]:
// UNOPT-NEXT:    [[TMP9:%.*]] = icmp ule ptr [[ARRAYIDX]], [[TMP7]], !annotation [[META3]]
// UNOPT-NEXT:    br i1 [[TMP9]], label %[[CONT4:.*]], label %[[TRAP3:.*]], {{!prof ![0-9]+}}, !annotation [[META3]]
// UNOPT:       [[TRAP3]]:
// UNOPT-NEXT:    call preserve_allcc void @__bounds_safety_soft_trap_s(ptr @trap.reason.1) #[[ATTR6]], !annotation [[META3]]
// UNOPT-NEXT:    br label %[[CONT4]], !annotation [[META3]]
// UNOPT:       [[CONT4]]:
// UNOPT-NEXT:    [[TMP10:%.*]] = icmp uge ptr [[ARRAYIDX]], [[WIDE_PTR_LB]], !annotation [[META4:![0-9]+]]
// UNOPT-NEXT:    br i1 [[TMP10]], label %[[CONT6:.*]], label %[[TRAP5:.*]], {{!prof ![0-9]+}}, !annotation [[META4]]
// UNOPT:       [[TRAP5]]:
// UNOPT-NEXT:    call preserve_allcc void @__bounds_safety_soft_trap_s(ptr @trap.reason.2) #[[ATTR6]], !annotation [[META4]]
// UNOPT-NEXT:    br label %[[CONT6]], !annotation [[META4]]
// UNOPT:       [[CONT6]]:
...
// UNOPT-TF-NEXT:    [[TMP2:%.*]] = call { i32, i1 } @llvm.sadd.with.overflow.i32(i32 [[TMP0]], i32 [[TMP1]]), !nosanitize [[META1:![0-9]+]]
// UNOPT-TF-NEXT:    [[TMP3:%.*]] = extractvalue { i32, i1 } [[TMP2]], 0, !nosanitize [[META1]]
// UNOPT-TF-NEXT:    [[TMP4:%.*]] = extractvalue { i32, i1 } [[TMP2]], 1, !nosanitize [[META1]]
// UNOPT-TF-NEXT:    [[TMP5:%.*]] = xor i1 [[TMP4]], true, !nosanitize [[META1]]
// UNOPT-TF-NEXT:    br i1 [[TMP5]], label %[[CONT:.*]], label %[[TRAP:.*]], {{!prof ![0-9]+}}, !nosanitize [[META1]]
// UNOPT-TF:       [[TRAP]]:
// UNOPT-TF-NEXT:    call void @llvm.ubsantrap(i8 0) #[[ATTR5:[0-9]+]], !nosanitize [[META1]]
// UNOPT-TF-NEXT:    unreachable, !nosanitize [[META1]]
// UNOPT-TF:       [[CONT]]:
...
// UNOPT-TF-NEXT:    [[TMP7:%.*]] = getelementptr i32, ptr [[ARRAYIDX]], i64 1, !annotation [[META3:![0-9]+]]
// UNOPT-TF-NEXT:    [[TMP8:%.*]] = icmp ule ptr [[TMP7]], [[WIDE_PTR_UB]], !annotation [[META3]]
// UNOPT-TF-NEXT:    br i1 [[TMP8]], label %[[CONT2:.*]], label %[[TRAP1:.*]], {{!prof ![0-9]+}}, !annotation [[META3]]
// UNOPT-TF:       [[TRAP1]]:
// UNOPT-TF-NEXT:    call preserve_allcc void @__bounds_safety_soft_trap_s(ptr @trap.reason) #[[ATTR6:[0-9]+]], !annotation [[META3]]
// UNOPT-TF-NEXT:    br label %[[CONT2]], !annotation [[META3]]
// UNOPT-TF:       [[CONT2]]:
// UNOPT-TF-NEXT:    [[TMP9:%.*]] = icmp ule ptr [[ARRAYIDX]], [[TMP7]], !annotation [[META3]]
// UNOPT-TF-NEXT:    br i1 [[TMP9]], label %[[CONT4:.*]], label %[[TRAP3:.*]], {{!prof ![0-9]+}}, !annotation [[META3]]
// UNOPT-TF:       [[TRAP3]]:
// UNOPT-TF-NEXT:    call preserve_allcc void @__bounds_safety_soft_trap_s(ptr @trap.reason.1) #[[ATTR6]], !annotation [[META3]]
// UNOPT-TF-NEXT:    br label %[[CONT4]], !annotation [[META3]]
// UNOPT-TF:       [[CONT4]]:
// UNOPT-TF-NEXT:    [[TMP10:%.*]] = icmp uge ptr [[ARRAYIDX]], [[WIDE_PTR_LB]], !annotation [[META4:![0-9]+]]
// UNOPT-TF-NEXT:    br i1 [[TMP10]], label %[[CONT6:.*]], label %[[TRAP5:.*]], {{!prof ![0-9]+}}, !annotation [[META4]]
// UNOPT-TF:       [[TRAP5]]:
// UNOPT-TF-NEXT:    call preserve_allcc void @__bounds_safety_soft_trap_s(ptr @trap.reason.2) #[[ATTR6]], !annotation [[META4]]
// UNOPT-TF-NEXT:    br label %[[CONT6]], !annotation [[META4]]
// UNOPT-TF:       [[CONT6]]:
...
// UNOPT-TFR-NEXT:    [[TMP2:%.*]] = call { i32, i1 } @llvm.sadd.with.overflow.i32(i32 [[TMP0]], i32 [[TMP1]]), !nosanitize [[META1:![0-9]+]]
// UNOPT-TFR-NEXT:    [[TMP3:%.*]] = extractvalue { i32, i1 } [[TMP2]], 0, !nosanitize [[META1]]
// UNOPT-TFR-NEXT:    [[TMP4:%.*]] = extractvalue { i32, i1 } [[TMP2]], 1, !nosanitize [[META1]]
// UNOPT-TFR-NEXT:    [[TMP5:%.*]] = xor i1 [[TMP4]], true, !nosanitize [[META1]]
// UNOPT-TFR-NEXT:    br i1 [[TMP5]], label %[[CONT:.*]], label %[[TRAP:.*]], {{!prof ![0-9]+}}, !nosanitize [[META1]]
// UNOPT-TFR:       [[TRAP]]:
// UNOPT-TFR-NEXT:    call void @ubsan_handler(i8 0) #[[ATTR4:[0-9]+]], !nosanitize [[META1]]
// UNOPT-TFR-NEXT:    br label %[[CONT]], !nosanitize [[META1]]
// UNOPT-TFR:       [[CONT]]:
...
// UNOPT-TFR-NEXT:    [[TMP7:%.*]] = getelementptr i32, ptr [[ARRAYIDX]], i64 1, !annotation [[META3:![0-9]+]]
// UNOPT-TFR-NEXT:    [[TMP8:%.*]] = icmp ule ptr [[TMP7]], [[WIDE_PTR_UB]], !annotation [[META3]]
// UNOPT-TFR-NEXT:    br i1 [[TMP8]], label %[[CONT2:.*]], label %[[TRAP1:.*]], {{!prof ![0-9]+}}, !annotation [[META3]]
// UNOPT-TFR:       [[TRAP1]]:
// UNOPT-TFR-NEXT:    call preserve_allcc void @__bounds_safety_soft_trap_s(ptr @trap.reason) #[[ATTR5:[0-9]+]], !annotation [[META3]]
// UNOPT-TFR-NEXT:    br label %[[CONT2]], !annotation [[META3]]
// UNOPT-TFR:       [[CONT2]]:
// UNOPT-TFR-NEXT:    [[TMP9:%.*]] = icmp ule ptr [[ARRAYIDX]], [[TMP7]], !annotation [[META3]]
// UNOPT-TFR-NEXT:    br i1 [[TMP9]], label %[[CONT4:.*]], label %[[TRAP3:.*]], {{!prof ![0-9]+}}, !annotation [[META3]]
// UNOPT-TFR:       [[TRAP3]]:
// UNOPT-TFR-NEXT:    call preserve_allcc void @__bounds_safety_soft_trap_s(ptr @trap.reason.1) #[[ATTR5]], !annotation [[META3]]
// UNOPT-TFR-NEXT:    br label %[[CONT4]], !annotation [[META3]]
// UNOPT-TFR:       [[CONT4]]:
// UNOPT-TFR-NEXT:    [[TMP10:%.*]] = icmp uge ptr [[ARRAYIDX]], [[WIDE_PTR_LB]], !annotation [[META4:![0-9]+]]
// UNOPT-TFR-NEXT:    br i1 [[TMP10]], label %[[CONT6:.*]], label %[[TRAP5:.*]], {{!prof ![0-9]+}}, !annotation [[META4]]
// UNOPT-TFR:       [[TRAP5]]:
// UNOPT-TFR-NEXT:    call preserve_allcc void @__bounds_safety_soft_trap_s(ptr @trap.reason.2) #[[ATTR5]], !annotation [[META4]]
// UNOPT-TFR-NEXT:    br label %[[CONT6]], !annotation [[META4]]
// UNOPT-TFR:       [[CONT6]]:
...
// UNOPT-LABEL: define i32 @read_cb(
...
// UNOPT-NEXT:    [[TMP1:%.*]] = load i32, ptr [[OTHER_ADDR]], align 4
// UNOPT-NEXT:    [[TMP2:%.*]] = call { i32, i1 } @llvm.sadd.with.overflow.i32(i32 [[TMP0]], i32 [[TMP1]]), !nosanitize [[META1]]
// UNOPT-NEXT:    [[TMP3:%.*]] = extractvalue { i32, i1 } [[TMP2]], 0, !nosanitize [[META1]]
// UNOPT-NEXT:    [[TMP4:%.*]] = extractvalue { i32, i1 } [[TMP2]], 1, !nosanitize [[META1]]
// UNOPT-NEXT:    [[TMP5:%.*]] = xor i1 [[TMP4]], true, !nosanitize [[META1]]
// UNOPT-NEXT:    br i1 [[TMP5]], label %[[CONT:.*]], label %[[TRAP:.*]], {{!prof ![0-9]+}}, !nosanitize [[META1]]
// UNOPT:       [[TRAP]]:
// UNOPT-NEXT:    call void @llvm.ubsantrap(i8 0) #[[ATTR5]], !nosanitize [[META1]]
// UNOPT-NEXT:    unreachable, !nosanitize [[META1]]
// UNOPT:       [[CONT]]:
// UNOPT-NEXT:    store i32 [[TMP3]], ptr [[TMP]], align 4
...
// UNOPT-NEXT:    [[TMP12:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP2]], i32 0, i32 0, !annotation [[META5]]
// UNOPT-NEXT:    store ptr [[WIDE_PTR_UB4]], ptr [[TMP12]], align 8, !annotation [[META5]]
...
// UNOPT-NEXT:    [[TMP13:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP11]], i32 0, i32 0, !annotation [[META5]]
// UNOPT-NEXT:    store ptr [[WIDE_PTR_LB13]], ptr [[TMP13]], align 8, !annotation [[META5]]
...
// UNOPT:       [[LAND_RHS]]:
// UNOPT-NEXT:    [[CONV:%.*]] = sext i32 [[TMP11]] to i64, !annotation [[META5]]
...
// UNOPT-NEXT:    [[TMP14:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP28]], i32 0, i32 0, !annotation [[META5]]
// UNOPT-NEXT:    store ptr [[WIDE_PTR_UB30]], ptr [[TMP14]], align 8, !annotation [[META5]]
...
// UNOPT:       [[LAND_RHS46]]:
// UNOPT-NEXT:    [[CMP47:%.*]] = icmp sle i32 0, [[TMP11]], !annotation [[META5]]
...
// UNOPT:       [[LAND_END49]]:
// UNOPT-NEXT:    [[TMP16:%.*]] = phi i1 [ false, %[[LAND_LHS_TRUE]] ], [ false, %[[CONT]] ], [ [[TMP15]], %[[LAND_END]] ], !annotation [[META5]]
// UNOPT-NEXT:    br i1 [[TMP16]], label %[[CONT51:.*]], label %[[TRAP50:.*]], {{!prof ![0-9]+}}, !annotation [[META5]]
// UNOPT:       [[TRAP50]]:
// UNOPT-NEXT:    call preserve_allcc void @__bounds_safety_soft_trap_s(ptr null) #[[ATTR6]], !annotation [[META5]]
// UNOPT-NEXT:    br label %[[CONT51]], !annotation [[META5]]
// UNOPT:       [[CONT51]]:
...
//
// UNOPT-TF-LABEL: define i32 @read_cb(
...
// UNOPT-TF-NEXT:    [[TMP1:%.*]] = load i32, ptr [[OTHER_ADDR]], align 4
// UNOPT-TF-NEXT:    [[TMP2:%.*]] = call { i32, i1 } @llvm.sadd.with.overflow.i32(i32 [[TMP0]], i32 [[TMP1]]), !nosanitize [[META1]]
// UNOPT-TF-NEXT:    [[TMP3:%.*]] = extractvalue { i32, i1 } [[TMP2]], 0, !nosanitize [[META1]]
// UNOPT-TF-NEXT:    [[TMP4:%.*]] = extractvalue { i32, i1 } [[TMP2]], 1, !nosanitize [[META1]]
// UNOPT-TF-NEXT:    [[TMP5:%.*]] = xor i1 [[TMP4]], true, !nosanitize [[META1]]
// UNOPT-TF-NEXT:    br i1 [[TMP5]], label %[[CONT:.*]], label %[[TRAP:.*]], {{!prof ![0-9]+}}, !nosanitize [[META1]]
// UNOPT-TF:       [[TRAP]]:
// UNOPT-TF-NEXT:    call void @llvm.ubsantrap(i8 0) #[[ATTR5]], !nosanitize [[META1]]
// UNOPT-TF-NEXT:    unreachable, !nosanitize [[META1]]
// UNOPT-TF:       [[CONT]]:
// UNOPT-TF-NEXT:    store i32 [[TMP3]], ptr [[TMP]], align 4
...
// UNOPT-TF-NEXT:    [[TMP12:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP2]], i32 0, i32 0, !annotation [[META5]]
// UNOPT-TF-NEXT:    store ptr [[WIDE_PTR_UB4]], ptr [[TMP12]], align 8, !annotation [[META5]]
...
// UNOPT-TF-NEXT:    [[TMP13:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP11]], i32 0, i32 0, !annotation [[META5]]
// UNOPT-TF-NEXT:    store ptr [[WIDE_PTR_LB13]], ptr [[TMP13]], align 8, !annotation [[META5]]
...
// UNOPT-TF:       [[LAND_RHS]]:
// UNOPT-TF-NEXT:    [[CONV:%.*]] = sext i32 [[TMP11]] to i64, !annotation [[META5]]
...
// UNOPT-TF-NEXT:    [[TMP14:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP28]], i32 0, i32 0, !annotation [[META5]]
// UNOPT-TF-NEXT:    store ptr [[WIDE_PTR_UB30]], ptr [[TMP14]], align 8, !annotation [[META5]]
...
// UNOPT-TF:       [[LAND_RHS46]]:
// UNOPT-TF-NEXT:    [[CMP47:%.*]] = icmp sle i32 0, [[TMP11]], !annotation [[META5]]
...
// UNOPT-TF:       [[LAND_END49]]:
// UNOPT-TF-NEXT:    [[TMP16:%.*]] = phi i1 [ false, %[[LAND_LHS_TRUE]] ], [ false, %[[CONT]] ], [ [[TMP15]], %[[LAND_END]] ], !annotation [[META5]]
// UNOPT-TF-NEXT:    br i1 [[TMP16]], label %[[CONT51:.*]], label %[[TRAP50:.*]], {{!prof ![0-9]+}}, !annotation [[META5]]
// UNOPT-TF:       [[TRAP50]]:
// UNOPT-TF-NEXT:    call preserve_allcc void @__bounds_safety_soft_trap_s(ptr null) #[[ATTR6]], !annotation [[META5]]
// UNOPT-TF-NEXT:    br label %[[CONT51]], !annotation [[META5]]
// UNOPT-TF:       [[CONT51]]:
...
//
// UNOPT-TFR-LABEL: define i32 @read_cb(
...
// UNOPT-TFR-NEXT:    [[TMP1:%.*]] = load i32, ptr [[OTHER_ADDR]], align 4
// UNOPT-TFR-NEXT:    [[TMP2:%.*]] = call { i32, i1 } @llvm.sadd.with.overflow.i32(i32 [[TMP0]], i32 [[TMP1]]), !nosanitize [[META1]]
// UNOPT-TFR-NEXT:    [[TMP3:%.*]] = extractvalue { i32, i1 } [[TMP2]], 0, !nosanitize [[META1]]
// UNOPT-TFR-NEXT:    [[TMP4:%.*]] = extractvalue { i32, i1 } [[TMP2]], 1, !nosanitize [[META1]]
// UNOPT-TFR-NEXT:    [[TMP5:%.*]] = xor i1 [[TMP4]], true, !nosanitize [[META1]]
// UNOPT-TFR-NEXT:    br i1 [[TMP5]], label %[[CONT:.*]], label %[[TRAP:.*]], {{!prof ![0-9]+}}, !nosanitize [[META1]]
// UNOPT-TFR:       [[TRAP]]:
// UNOPT-TFR-NEXT:    call void @ubsan_handler(i8 0) #[[ATTR4]], !nosanitize [[META1]]
// UNOPT-TFR-NEXT:    br label %[[CONT]], !nosanitize [[META1]]
// UNOPT-TFR:       [[CONT]]:
// UNOPT-TFR-NEXT:    store i32 [[TMP3]], ptr [[TMP]], align 4
...
// UNOPT-TFR-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[AGG_TEMP1]], ptr align 8 [[AGG_TEMP]], i64 24, i1 false), !annotation [[META5:![0-9]+]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_PTR_ADDR:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP1]], i32 0, i32 0, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_PTR:%.*]] = load ptr, ptr [[WIDE_PTR_PTR_ADDR]], align 8, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_UB_ADDR:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP1]], i32 0, i32 1, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_UB:%.*]] = load ptr, ptr [[WIDE_PTR_UB_ADDR]], align 8, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_LB_ADDR:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP1]], i32 0, i32 2, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_LB:%.*]] = load ptr, ptr [[WIDE_PTR_LB_ADDR]], align 8, !annotation [[META5]]
// UNOPT-TFR-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[AGG_TEMP2]], ptr align 8 [[AGG_TEMP]], i64 24, i1 false), !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_UB_ADDR3:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP2]], i32 0, i32 1, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_UB4:%.*]] = load ptr, ptr [[WIDE_PTR_UB_ADDR3]], align 8, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[TMP12:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP2]], i32 0, i32 0, !annotation [[META5]]
// UNOPT-TFR-NEXT:    store ptr [[WIDE_PTR_UB4]], ptr [[TMP12]], align 8, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_PTR_ADDR5:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP2]], i32 0, i32 0, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_PTR6:%.*]] = load ptr, ptr [[WIDE_PTR_PTR_ADDR5]], align 8, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_UB_ADDR7:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP2]], i32 0, i32 1, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_UB8:%.*]] = load ptr, ptr [[WIDE_PTR_UB_ADDR7]], align 8, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_LB_ADDR9:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP2]], i32 0, i32 2, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_LB10:%.*]] = load ptr, ptr [[WIDE_PTR_LB_ADDR9]], align 8, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[CMP:%.*]] = icmp ule ptr [[WIDE_PTR_PTR]], [[WIDE_PTR_PTR6]], !annotation [[META5]]
// UNOPT-TFR-NEXT:    br i1 [[CMP]], label %[[LAND_LHS_TRUE:.*]], label %[[LAND_END49:.*]], !annotation [[META5]]
// UNOPT-TFR:       [[LAND_LHS_TRUE]]:
// UNOPT-TFR-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[AGG_TEMP11]], ptr align 8 [[AGG_TEMP]], i64 24, i1 false), !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_LB_ADDR12:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP11]], i32 0, i32 2, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_LB13:%.*]] = load ptr, ptr [[WIDE_PTR_LB_ADDR12]], align 8, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[TMP13:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP11]], i32 0, i32 0, !annotation [[META5]]
// UNOPT-TFR-NEXT:    store ptr [[WIDE_PTR_LB13]], ptr [[TMP13]], align 8, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_PTR_ADDR14:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP11]], i32 0, i32 0, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_PTR15:%.*]] = load ptr, ptr [[WIDE_PTR_PTR_ADDR14]], align 8, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_UB_ADDR16:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP11]], i32 0, i32 1, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_UB17:%.*]] = load ptr, ptr [[WIDE_PTR_UB_ADDR16]], align 8, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_LB_ADDR18:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP11]], i32 0, i32 2, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_LB19:%.*]] = load ptr, ptr [[WIDE_PTR_LB_ADDR18]], align 8, !annotation [[META5]]
// UNOPT-TFR-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[AGG_TEMP20]], ptr align 8 [[AGG_TEMP]], i64 24, i1 false), !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_PTR_ADDR21:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP20]], i32 0, i32 0, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_PTR22:%.*]] = load ptr, ptr [[WIDE_PTR_PTR_ADDR21]], align 8, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_UB_ADDR23:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP20]], i32 0, i32 1, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_UB24:%.*]] = load ptr, ptr [[WIDE_PTR_UB_ADDR23]], align 8, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_LB_ADDR25:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP20]], i32 0, i32 2, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_LB26:%.*]] = load ptr, ptr [[WIDE_PTR_LB_ADDR25]], align 8, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[CMP27:%.*]] = icmp ule ptr [[WIDE_PTR_PTR15]], [[WIDE_PTR_PTR22]], !annotation [[META5]]
// UNOPT-TFR-NEXT:    br i1 [[CMP27]], label %[[LAND_RHS:.*]], label %[[LAND_END49]], !annotation [[META5]]
// UNOPT-TFR:       [[LAND_RHS]]:
// UNOPT-TFR-NEXT:    [[CONV:%.*]] = sext i32 [[TMP11]] to i64, !annotation [[META5]]
// UNOPT-TFR-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[AGG_TEMP28]], ptr align 8 [[AGG_TEMP]], i64 24, i1 false), !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_UB_ADDR29:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP28]], i32 0, i32 1, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_UB30:%.*]] = load ptr, ptr [[WIDE_PTR_UB_ADDR29]], align 8, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[TMP14:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP28]], i32 0, i32 0, !annotation [[META5]]
// UNOPT-TFR-NEXT:    store ptr [[WIDE_PTR_UB30]], ptr [[TMP14]], align 8, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_PTR_ADDR31:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP28]], i32 0, i32 0, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_PTR32:%.*]] = load ptr, ptr [[WIDE_PTR_PTR_ADDR31]], align 8, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_UB_ADDR33:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP28]], i32 0, i32 1, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_UB34:%.*]] = load ptr, ptr [[WIDE_PTR_UB_ADDR33]], align 8, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_LB_ADDR35:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP28]], i32 0, i32 2, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_LB36:%.*]] = load ptr, ptr [[WIDE_PTR_LB_ADDR35]], align 8, !annotation [[META5]]
// UNOPT-TFR-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[AGG_TEMP37]], ptr align 8 [[AGG_TEMP]], i64 24, i1 false), !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_PTR_ADDR38:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP37]], i32 0, i32 0, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_PTR39:%.*]] = load ptr, ptr [[WIDE_PTR_PTR_ADDR38]], align 8, !annotation [[META5]]
// UNOPT-TFR-NEXT:    [[WIDE_PTR_UB_ADDR40:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP37]], i32 0, i32 1, !annotation [[META5]]
...
// UNOPT-TFR-NEXT:    br i1 [[CMP44]], label %[[LAND_RHS46:.*]], label %[[LAND_END:.*]], !annotation [[META5]]
// UNOPT-TFR:       [[LAND_RHS46]]:
// UNOPT-TFR-NEXT:    [[CMP47:%.*]] = icmp sle i32 0, [[TMP11]], !annotation [[META5]]
// UNOPT-TFR-NEXT:    br label %[[LAND_END]], !annotation [[META5]]
// UNOPT-TFR:       [[LAND_END]]:
// UNOPT-TFR-NEXT:    [[TMP15:%.*]] = phi i1 [ false, %[[LAND_RHS]] ], [ [[CMP47]], %[[LAND_RHS46]] ]
// UNOPT-TFR-NEXT:    br label %[[LAND_END49]], !annotation [[META5]]
// UNOPT-TFR:       [[LAND_END49]]:
// UNOPT-TFR-NEXT:    [[TMP16:%.*]] = phi i1 [ false, %[[LAND_LHS_TRUE]] ], [ false, %[[CONT]] ], [ [[TMP15]], %[[LAND_END]] ], !annotation [[META5]]
// UNOPT-TFR-NEXT:    br i1 [[TMP16]], label %[[CONT51:.*]], label %[[TRAP50:.*]], {{!prof ![0-9]+}}, !annotation [[META5]]
// UNOPT-TFR:       [[TRAP50]]:
// UNOPT-TFR-NEXT:    call preserve_allcc void @__bounds_safety_soft_trap_s(ptr null) #[[ATTR5]], !annotation [[META5]]
// UNOPT-TFR-NEXT:    br label %[[CONT51]], !annotation [[META5]]
// UNOPT-TFR:       [[CONT51]]:
...
// UNOPT: attributes #[[ATTR3:[0-9]+]] = { nocallback nofree nosync nounwind willreturn memory(argmem: readwrite) }
...
// UNOPT-TF: attributes #[[ATTR3:[0-9]+]] = { nocallback nofree nosync nounwind willreturn memory(argmem: readwrite) }
...
// UNOPT-TFR: attributes #[[ATTR2:[0-9]+]] = { nocallback nofree nosync nounwind willreturn memory(argmem: readwrite) }
