...
// UNOPT:       [[TRAP]]:
// UNOPT-NEXT:    call preserve_allcc void @custom_func() #[[ATTR2:[0-9]+]], !annotation [[META2]]
...
// UNOPT:       [[TRAP1]]:
// UNOPT-NEXT:    call preserve_allcc void @custom_func() #[[ATTR2]], !annotation [[META2]]
...
// UNOPT:       [[TRAP3]]:
// UNOPT-NEXT:    call preserve_allcc void @custom_func() #[[ATTR2]], !annotation [[META4]]
