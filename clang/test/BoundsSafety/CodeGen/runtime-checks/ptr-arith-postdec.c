...
// O2-LABEL: @foo(
// O2-NEXT:  entry:
// O2-NEXT:    [[UPPER:%.*]] = getelementptr inbounds i8, ptr [[A:%.*]], i64 4
...
// O0-NEXT:    [[TMP1:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[P]], i32 0, i32 0
// O0-NEXT:    store ptr [[TMP0]], ptr [[TMP1]], align 8
// O0-NEXT:    [[TMP2:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[P]], i32 0, i32 1
// O0-NEXT:    store ptr [[UPPER]], ptr [[TMP2]], align 8
// O0-NEXT:    [[TMP3:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[P]], i32 0, i32 2
...
// O0-NEXT:    [[TMP4:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[TMP]], i32 0, i32 0
// O0-NEXT:    [[TMP5:%.*]] = load ptr, ptr [[TMP4]], align 8
// O0-NEXT:    [[BOUND_PTR_ARITH:%.*]] = getelementptr i32, ptr [[TMP5]], i64 -1
// O0-NEXT:    [[TMP6:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[P]], i32 0, i32 0
// O0-NEXT:    store ptr [[BOUND_PTR_ARITH]], ptr [[TMP6]], align 8
// O0-NEXT:    [[TMP7:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[TMP]], i32 0, i32 1
// O0-NEXT:    [[TMP8:%.*]] = load ptr, ptr [[TMP7]], align 8
// O0-NEXT:    [[TMP9:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[P]], i32 0, i32 1
// O0-NEXT:    store ptr [[TMP8]], ptr [[TMP9]], align 8
// O0-NEXT:    [[TMP10:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[TMP]], i32 0, i32 2
// O0-NEXT:    [[TMP11:%.*]] = load ptr, ptr [[TMP10]], align 8
// O0-NEXT:    [[TMP12:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[P]], i32 0, i32 2
