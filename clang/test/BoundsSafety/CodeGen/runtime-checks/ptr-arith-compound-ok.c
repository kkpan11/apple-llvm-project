...
// O0-NEXT:    [[TMP0:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[P]], i32 0, i32 0
// O0-NEXT:    store ptr [[ARRAYDECAY]], ptr [[TMP0]], align 8
// O0-NEXT:    [[TMP1:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[P]], i32 0, i32 1
// O0-NEXT:    store ptr [[UPPER]], ptr [[TMP1]], align 8
// O0-NEXT:    [[TMP2:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[P]], i32 0, i32 2
...
// O0-NEXT:    [[TMP3:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[TMP]], i32 0, i32 0
// O0-NEXT:    [[TMP4:%.*]] = load ptr, ptr [[TMP3]], align 8
// O0-NEXT:    [[BOUND_PTR_ARITH:%.*]] = getelementptr i32, ptr [[TMP4]], i64 4
// O0-NEXT:    [[TMP5:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[P]], i32 0, i32 0
// O0-NEXT:    store ptr [[BOUND_PTR_ARITH]], ptr [[TMP5]], align 8
// O0-NEXT:    [[TMP6:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[TMP]], i32 0, i32 1
// O0-NEXT:    [[TMP7:%.*]] = load ptr, ptr [[TMP6]], align 8
// O0-NEXT:    [[TMP8:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[P]], i32 0, i32 1
// O0-NEXT:    store ptr [[TMP7]], ptr [[TMP8]], align 8
// O0-NEXT:    [[TMP9:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[TMP]], i32 0, i32 2
// O0-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[TMP9]], align 8
// O0-NEXT:    [[TMP11:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[P]], i32 0, i32 2
...
// O0-NEXT:    [[TMP12:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[TMP1TMP1]], i32 0, i32 0
// O0-NEXT:    [[TMP13:%.*]] = load ptr, ptr [[TMP12]], align 8
// O0-NEXT:    [[BOUND_PTR_ARITH2:%.*]] = getelementptr i32, ptr [[TMP13]], i64 -1
// O0-NEXT:    [[TMP14:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[P]], i32 0, i32 0
// O0-NEXT:    store ptr [[BOUND_PTR_ARITH2]], ptr [[TMP14]], align 8
// O0-NEXT:    [[TMP15:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[TMP1TMP1]], i32 0, i32 1
// O0-NEXT:    [[TMP16:%.*]] = load ptr, ptr [[TMP15]], align 8
// O0-NEXT:    [[TMP17:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[P]], i32 0, i32 1
// O0-NEXT:    store ptr [[TMP16]], ptr [[TMP17]], align 8
// O0-NEXT:    [[TMP18:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[TMP1TMP1]], i32 0, i32 2
// O0-NEXT:    [[TMP19:%.*]] = load ptr, ptr [[TMP18]], align 8
// O0-NEXT:    [[TMP20:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[P]], i32 0, i32 2
