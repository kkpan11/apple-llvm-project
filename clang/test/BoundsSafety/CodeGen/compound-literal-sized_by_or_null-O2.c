...
// CHECK-NEXT:    tail call void @consume_sbon([2 x i64] [[DOTFCA_1_INSERT]]) #[[ATTR11:[0-9]+]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: define [2 x i64] @return_sbon(
// CHECK-SAME: i32 noundef [[NEW_COUNT:%.*]], ptr nofreeobj noundef readonly align 8 captures(none) dead_on_return dereferenceable(24) [[NEW_PTR:%.*]]) local_unnamed_addr #[[ATTR3]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[AGG_TEMP_SROA_0_0_COPYLOAD:%.*]] = load ptr, ptr [[NEW_PTR]], align 8
// CHECK-NEXT:    [[AGG_TEMP_SROA_2_0_NEW_PTR_SROA_IDX:%.*]] = getelementptr inbounds nuw i8, ptr [[NEW_PTR]], i64 8
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[ARR:%.*]] = alloca [2 x [[STRUCT_SBON:%.*]]], align 8
...
// CHECK-NEXT:    call void @consume_sbon_arr(ptr noundef nonnull [[ARR]]) #[[ATTR11]]
...
// CHECK-LABEL: define void @assign_via_ptr_from_sbon(
...
// CHECK-LABEL: define void @assign_operator_from_sbon(
...
// CHECK-LABEL: define void @local_var_init_from_sbon(
...
// CHECK-LABEL: define void @call_arg_from_sbon(
...
// CHECK-NEXT:    [[DOTFCA_1_INSERT:%.*]] = insertvalue [2 x i64] [[DOTFCA_0_INSERT]], i64 [[TMP0]], 1
// CHECK-NEXT:    tail call void @consume_sbon([2 x i64] [[DOTFCA_1_INSERT]]) #[[ATTR11]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: define [2 x i64] @return_sbon_from_sbon(
...
// CHECK-LABEL: define void @construct_not_used_from_sbon(
// CHECK-SAME: i32 noundef [[NEW_COUNT:%.*]], ptr nofree noundef readnone captures(address_is_null) [[NEW_PTR:%.*]]) local_unnamed_addr #[[ATTR9]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[DOTNOT:%.*]] = icmp ne ptr [[NEW_PTR]], null, !annotation [[META25]]
// CHECK-NEXT:    [[CMP_NOT46:%.*]] = icmp slt i32 [[NEW_COUNT]], 0
...
// CHECK-LABEL: define void @assign_via_ptr_nested_from_sbon(
...
// CHECK-LABEL: define void @assign_via_ptr_nested_v2_from_sbon(
// CHECK-SAME: ptr nofree noundef writeonly captures(none) [[PTR:%.*]], ptr noundef [[NEW_PTR:%.*]], i32 noundef [[NEW_COUNT:%.*]]) local_unnamed_addr #[[ATTR8]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[DOTNOT:%.*]] = icmp ne ptr [[NEW_PTR]], null, !annotation [[META25]]
// CHECK-NEXT:    [[CMP_NOT46:%.*]] = icmp slt i32 [[NEW_COUNT]], 0
...
// CHECK-LABEL: define void @array_of_struct_init_from_sbon(
...
// CHECK-LABEL: define void @assign_via_ptr_other_data_side_effect_from_sbon(
...
// CHECK-LABEL: define void @assign_via_ptr_other_data_side_effect_zero_ptr_from_sbon(
...
// CHECK-LABEL: define void @call_arg_transparent_union_from_sbon(
// CHECK-SAME: i32 noundef [[NEW_COUNT:%.*]], ptr nofreeobj noundef readonly align 8 captures(none) dead_on_return dereferenceable(24) [[NEW_PTR:%.*]]) local_unnamed_addr #[[ATTR5]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[AGG_TMP:%.*]] = alloca [[UNION_TRANSPARENTUNION:%.*]], align 8
// CHECK-NEXT:    [[AGG_TEMP_SROA_0_0_COPYLOAD:%.*]] = load ptr, ptr [[NEW_PTR]], align 8
...
// CHECK-LABEL: define void @call_arg_transparent_union_untransparently_from_sbon(
// CHECK-SAME: i32 noundef [[NEW_COUNT:%.*]], ptr nofreeobj noundef readonly align 8 captures(none) dead_on_return dereferenceable(24) [[NEW_PTR:%.*]]) local_unnamed_addr #[[ATTR5]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[BYVAL_TEMP:%.*]] = alloca [[UNION_TRANSPARENTUNION:%.*]], align 8
// CHECK-NEXT:    [[AGG_TEMP_SROA_0_0_COPYLOAD:%.*]] = load ptr, ptr [[NEW_PTR]], align 8
...
// CHECK: [[META18]] = !{!"sbon", [[META3]], i64 0, [[META12]], i64 8}
// CHECK: [[TBAA19]] = !{[[META18]], [[META12]], i64 8}
// CHECK: [[TBAA20]] = !{[[META21:![0-9]+]], [[META3]], i64 0}
// CHECK: [[META21]] = !{!"sbon_with_other_data", [[META3]], i64 0, [[META12]], i64 8, [[META3]], i64 16}
