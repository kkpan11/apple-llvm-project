...
// RUN: %clang_cc1 -O2 -triple arm64-apple-ios -emit-llvm -x objective-c -fexperimental-bounds-safety-objc -fbounds-safety -fbounds-safety-bringup-missing-checks=compound_literal_init -Wno-bounds-attributes-init-list-side-effect %s -o - | FileCheck %s
...
// CHECK: [[META17]] = !{!"sb", [[META3]], i64 0, [[META12]], i64 8}
// CHECK: [[TBAA18]] = !{[[META17]], [[META12]], i64 8}
// CHECK: [[TBAA19]] = !{[[META20:![0-9]+]], [[META3]], i64 0}
// CHECK: [[META20]] = !{!"sb_with_other_data", [[META3]], i64 0, [[META12]], i64 8, [[META3]], i64 16}
