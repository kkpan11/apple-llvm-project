...
// RUN: %clang_cc1 -O0 -fbounds-safety -fbounds-safety-bringup-missing-checks=access_size -triple arm64-apple-ios -emit-llvm %s -o - | FileCheck --check-prefixes=NEW %s
// RUN: %clang_cc1 -O0 -fbounds-safety -fno-bounds-safety-bringup-missing-checks=access_size -triple arm64-apple-ios -emit-llvm %s -o - | FileCheck --check-prefixes=LEGACY %s
#include <ptrcheck.h>
#include <stdint.h>
...
// NEW-NEXT:    [[TMP1:%.*]] = icmp ult ptr [[ARRAYIDX]], [[WIDE_PTR_UB]], !annotation [[META1:![0-9]+]]
// NEW-NEXT:    br i1 [[TMP1]], label %[[CONT:.*]], label %[[TRAP:.*]], {{!prof ![0-9]+}}, !annotation [[META1]]
// NEW:       [[TRAP]]:
...
// NEW-NEXT:    br i1 [[TMP2]], label %[[CONT2:.*]], label %[[TRAP1:.*]], {{!prof ![0-9]+}}, !annotation [[META3]]
// NEW:       [[TRAP1]]:
...
// LEGACY-NEXT:    [[TMP1:%.*]] = icmp ult ptr [[ARRAYIDX]], [[WIDE_PTR_UB]], !annotation [[META1:![0-9]+]]
// LEGACY-NEXT:    br i1 [[TMP1]], label %[[CONT:.*]], label %[[TRAP:.*]], {{!prof ![0-9]+}}, !annotation [[META1]]
// LEGACY:       [[TRAP]]:
// LEGACY-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3:[0-9]+]], !annotation [[META1]]
// LEGACY-NEXT:    unreachable, !annotation [[META1]]
// LEGACY:       [[CONT]]:
// LEGACY-NEXT:    [[TMP2:%.*]] = icmp uge ptr [[ARRAYIDX]], [[WIDE_PTR_LB]], !annotation [[META3:![0-9]+]]
// LEGACY-NEXT:    br i1 [[TMP2]], label %[[CONT2:.*]], label %[[TRAP1:.*]], {{!prof ![0-9]+}}, !annotation [[META3]]
// LEGACY:       [[TRAP1]]:
...
// NEW-NEXT:    br i1 [[TMP2]], label %[[CONT:.*]], label %[[TRAP:.*]], {{!prof ![0-9]+}}, !annotation [[META4]]
// NEW:       [[TRAP]]:
...
// NEW-NEXT:    br i1 [[TMP3]], label %[[CONT2:.*]], label %[[TRAP1:.*]], {{!prof ![0-9]+}}, !annotation [[META4]]
// NEW:       [[TRAP1]]:
// NEW-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], !annotation [[META4]]
// NEW-NEXT:    unreachable, !annotation [[META4]]
// NEW:       [[CONT2]]:
...
// LEGACY-NEXT:    [[WIDE_PTR_LB:%.*]] = load ptr, ptr [[WIDE_PTR_LB_ADDR]], align 8
// LEGACY-NEXT:    [[TMP1:%.*]] = icmp ult ptr [[ARRAYIDX]], [[WIDE_PTR_UB]], !annotation [[META1]]
// LEGACY-NEXT:    br i1 [[TMP1]], label %[[CONT:.*]], label %[[TRAP:.*]], {{!prof ![0-9]+}}, !annotation [[META1]]
// LEGACY:       [[TRAP]]:
// LEGACY-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], !annotation [[META1]]
// LEGACY-NEXT:    unreachable, !annotation [[META1]]
// LEGACY:       [[CONT]]:
...
//.
// NEW: [[META1]] = !{!"bounds-safety-check-ptr-lt-upper-bound"}
// NEW: [[META3]] = !{!"bounds-safety-check-ptr-ge-lower-bound"}
// NEW: [[META4]] = !{!"bounds-safety-check-ptr-le-upper-bound"}
//.
// LEGACY: [[META1]] = !{!"bounds-safety-check-ptr-lt-upper-bound"}
