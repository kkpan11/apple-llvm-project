...
// RUN: %clang_cc1 -O2  -fbounds-safety -triple arm64e-apple-iphoneos -emit-llvm %s -o - | FileCheck %s --check-prefix=CHECK
// RUN: %clang_cc1 -O2  -fbounds-safety -triple arm64e-apple-iphoneos -x objective-c -fexperimental-bounds-safety-objc -emit-llvm %s -o - | FileCheck %s --check-prefix=CHECK-OBJC
...
// CHECK-NEXT:    ret void
//
// CHECK-OBJC-LABEL: define dso_local void @simple_no_flexbase_update(
// CHECK-OBJC-SAME: ptr noundef readonly captures(none) [[P:%.*]]) local_unnamed_addr #[[ATTR0:[0-9]+]] {
// CHECK-OBJC-NEXT:  [[ENTRY:.*:]]
// CHECK-OBJC-NEXT:    [[AGG_TEMP_SROA_0_0_COPYLOAD:%.*]] = load ptr, ptr [[P]], align 8
// CHECK-OBJC-NEXT:    [[AGG_TEMP_SROA_2_0_P_SROA_IDX:%.*]] = getelementptr inbounds nuw i8, ptr [[P]], i64 8
// CHECK-OBJC-NEXT:    [[AGG_TEMP_SROA_2_0_COPYLOAD:%.*]] = load ptr, ptr [[AGG_TEMP_SROA_2_0_P_SROA_IDX]], align 8
// CHECK-OBJC-NEXT:    [[AGG_TEMP_SROA_3_0_P_SROA_IDX:%.*]] = getelementptr inbounds nuw i8, ptr [[P]], i64 16
// CHECK-OBJC-NEXT:    [[AGG_TEMP_SROA_3_0_COPYLOAD:%.*]] = load ptr, ptr [[AGG_TEMP_SROA_3_0_P_SROA_IDX]], align 8, !tbaa {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[AGG_TEMP_SROA_0_0_COPYLOAD]], i64 4
// CHECK-OBJC-NEXT:    [[TMP1:%.*]] = icmp ule ptr [[TMP0]], [[AGG_TEMP_SROA_2_0_COPYLOAD]], !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[TMP2:%.*]] = icmp ule ptr [[AGG_TEMP_SROA_3_0_COPYLOAD]], [[AGG_TEMP_SROA_0_0_COPYLOAD]], !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[OR_COND:%.*]] = select i1 [[TMP1]], i1 [[TMP2]], i1 false, !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    br i1 [[OR_COND]], label %[[CONT1:.*]], label %[[TRAP:.*]], !prof {{![0-9]+}}, !annotation {{![0-9]+}}
// CHECK-OBJC:       [[TRAP]]:
// CHECK-OBJC-NEXT:    tail call void @llvm.ubsantrap(i8 25) #[[ATTR5:[0-9]+]], !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    unreachable, !annotation {{![0-9]+}}
// CHECK-OBJC:       [[CONT1]]:
// CHECK-OBJC-NEXT:    store i32 11, ptr [[AGG_TEMP_SROA_0_0_COPYLOAD]], align 4, !tbaa {{![0-9]+}}
...
// CHECK-NEXT:    ret void
//
// CHECK-OBJC-LABEL: define dso_local void @simple_flexbase_update(
// CHECK-OBJC-SAME: ptr noundef readonly captures(none) [[P:%.*]]) local_unnamed_addr #[[ATTR0]] {
// CHECK-OBJC-NEXT:  [[ENTRY:.*:]]
// CHECK-OBJC-NEXT:    [[P2_SROA_0_0_COPYLOAD:%.*]] = load ptr, ptr [[P]], align 8
// CHECK-OBJC-NEXT:    [[P2_SROA_4_0_P_SROA_IDX:%.*]] = getelementptr inbounds nuw i8, ptr [[P]], i64 8
// CHECK-OBJC-NEXT:    [[P2_SROA_4_0_COPYLOAD:%.*]] = load ptr, ptr [[P2_SROA_4_0_P_SROA_IDX]], align 8
// CHECK-OBJC-NEXT:    [[P2_SROA_5_0_P_SROA_IDX:%.*]] = getelementptr inbounds nuw i8, ptr [[P]], i64 16
// CHECK-OBJC-NEXT:    [[P2_SROA_5_0_COPYLOAD:%.*]] = load ptr, ptr [[P2_SROA_5_0_P_SROA_IDX]], align 8, !tbaa {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[P2_SROA_0_0_COPYLOAD]], i64 4
// CHECK-OBJC-NEXT:    [[TMP1:%.*]] = icmp ule ptr [[TMP0]], [[P2_SROA_4_0_COPYLOAD]], !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[TMP2:%.*]] = icmp ule ptr [[P2_SROA_5_0_COPYLOAD]], [[P2_SROA_0_0_COPYLOAD]], !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[OR_COND:%.*]] = select i1 [[TMP1]], i1 [[TMP2]], i1 false, !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    br i1 [[OR_COND]], label %[[CONT1:.*]], label %[[TRAP:.*]], !prof {{![0-9]+}}, !annotation {{![0-9]+}}
// CHECK-OBJC:       [[TRAP]]:
// CHECK-OBJC-NEXT:    tail call void @llvm.ubsantrap(i8 25) #[[ATTR5]], !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    unreachable, !annotation {{![0-9]+}}
// CHECK-OBJC:       [[CONT1]]:
// CHECK-OBJC-NEXT:    store i32 11, ptr [[P2_SROA_0_0_COPYLOAD]], align 4, !tbaa {{![0-9]+}}
// CHECK-OBJC-NEXT:    ret void
//
...
// CHECK-NEXT:    ret void
//
// CHECK-OBJC-LABEL: define dso_local void @simple_flexbase_self_assign(
// CHECK-OBJC-SAME: ptr noundef readonly captures(none) [[P:%.*]]) local_unnamed_addr #[[ATTR0]] {
// CHECK-OBJC-NEXT:  [[ENTRY:.*:]]
// CHECK-OBJC-NEXT:    [[AGG_TEMP_SROA_0_0_COPYLOAD:%.*]] = load ptr, ptr [[P]], align 8
// CHECK-OBJC-NEXT:    [[AGG_TEMP_SROA_2_0_P_SROA_IDX:%.*]] = getelementptr inbounds nuw i8, ptr [[P]], i64 8
...
// CHECK-NEXT:    ret void
//
// CHECK-OBJC-LABEL: define dso_local void @shared_no_flexbase_update(
// CHECK-OBJC-SAME: ptr noundef readonly captures(none) [[P:%.*]]) local_unnamed_addr #[[ATTR2:[0-9]+]] {
// CHECK-OBJC-NEXT:  [[ENTRY:.*:]]
// CHECK-OBJC-NEXT:    [[CALL:%.*]] = tail call ptr @baz(i32 noundef 11) #[[ATTR6:[0-9]+]]
// CHECK-OBJC-NEXT:    [[AGG_TEMP29_SROA_0_0_COPYLOAD:%.*]] = load ptr, ptr [[P]], align 8
// CHECK-OBJC-NEXT:    [[AGG_TEMP29_SROA_2_0_P_SROA_IDX:%.*]] = getelementptr inbounds nuw i8, ptr [[P]], i64 8
// CHECK-OBJC-NEXT:    [[AGG_TEMP29_SROA_2_0_COPYLOAD:%.*]] = load ptr, ptr [[AGG_TEMP29_SROA_2_0_P_SROA_IDX]], align 8
// CHECK-OBJC-NEXT:    [[AGG_TEMP29_SROA_3_0_P_SROA_IDX:%.*]] = getelementptr inbounds nuw i8, ptr [[P]], i64 16
// CHECK-OBJC-NEXT:    [[AGG_TEMP29_SROA_3_0_COPYLOAD:%.*]] = load ptr, ptr [[AGG_TEMP29_SROA_3_0_P_SROA_IDX]], align 8, !tbaa {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[AGG_TEMP29_SROA_0_0_COPYLOAD]], i64 16
// CHECK-OBJC-NEXT:    [[TMP1:%.*]] = icmp ule ptr [[TMP0]], [[AGG_TEMP29_SROA_2_0_COPYLOAD]], !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[TMP2:%.*]] = icmp ule ptr [[AGG_TEMP29_SROA_3_0_COPYLOAD]], [[AGG_TEMP29_SROA_0_0_COPYLOAD]], !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[OR_COND:%.*]] = select i1 [[TMP1]], i1 [[TMP2]], i1 false, !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    br i1 [[OR_COND]], label %[[CONT37:.*]], label %[[TRAP:.*]], !prof {{![0-9]+}}, !annotation {{![0-9]+}}
// CHECK-OBJC:       [[TRAP]]:
// CHECK-OBJC-NEXT:    tail call void @llvm.ubsantrap(i8 25) #[[ATTR5]], !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    unreachable, !annotation {{![0-9]+}}
// CHECK-OBJC:       [[CONT37]]:
// CHECK-OBJC-NEXT:    store i32 11, ptr [[AGG_TEMP29_SROA_0_0_COPYLOAD]], align 8, !tbaa {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[AGG_TEMP45_SROA_0_0_COPYLOAD:%.*]] = load ptr, ptr [[P]], align 8
// CHECK-OBJC-NEXT:    [[AGG_TEMP45_SROA_2_0_COPYLOAD:%.*]] = load ptr, ptr [[AGG_TEMP29_SROA_2_0_P_SROA_IDX]], align 8
// CHECK-OBJC-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[AGG_TEMP45_SROA_0_0_COPYLOAD]], i64 16
// CHECK-OBJC-NEXT:    [[TMP4:%.*]] = icmp ule ptr [[TMP3]], [[AGG_TEMP45_SROA_2_0_COPYLOAD]], !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[TMP5:%.*]] = icmp ule ptr [[AGG_TEMP29_SROA_3_0_COPYLOAD]], [[AGG_TEMP45_SROA_0_0_COPYLOAD]], !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[OR_COND54:%.*]] = select i1 [[TMP4]], i1 [[TMP5]], i1 false, !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    br i1 [[OR_COND54]], label %[[CONT53:.*]], label %[[TRAP]], !prof {{![0-9]+}}, !annotation {{![0-9]+}}
// CHECK-OBJC:       [[CONT53]]:
// CHECK-OBJC-NEXT:    [[PTR:%.*]] = getelementptr inbounds nuw i8, ptr [[AGG_TEMP45_SROA_0_0_COPYLOAD]], i64 8
// CHECK-OBJC-NEXT:    store ptr [[CALL]], ptr [[PTR]], align 8, !tbaa {{![0-9]+}}
// CHECK-OBJC-NEXT:    ret void
//
...
// CHECK-NEXT:    ret void
//
// CHECK-OBJC-LABEL: define dso_local void @shared_no_flexbase_update_reverse(
// CHECK-OBJC-SAME: ptr noundef readonly captures(none) [[P:%.*]]) local_unnamed_addr #[[ATTR2]] {
// CHECK-OBJC-NEXT:  [[ENTRY:.*:]]
// CHECK-OBJC-NEXT:    [[CALL:%.*]] = tail call ptr @baz(i32 noundef 11) #[[ATTR6]]
// CHECK-OBJC-NEXT:    [[AGG_TEMP36_SROA_0_0_COPYLOAD:%.*]] = load ptr, ptr [[P]], align 8
// CHECK-OBJC-NEXT:    [[AGG_TEMP36_SROA_2_0_P_SROA_IDX:%.*]] = getelementptr inbounds nuw i8, ptr [[P]], i64 8
// CHECK-OBJC-NEXT:    [[AGG_TEMP36_SROA_2_0_COPYLOAD:%.*]] = load ptr, ptr [[AGG_TEMP36_SROA_2_0_P_SROA_IDX]], align 8
// CHECK-OBJC-NEXT:    [[AGG_TEMP36_SROA_3_0_P_SROA_IDX:%.*]] = getelementptr inbounds nuw i8, ptr [[P]], i64 16
// CHECK-OBJC-NEXT:    [[AGG_TEMP36_SROA_3_0_COPYLOAD:%.*]] = load ptr, ptr [[AGG_TEMP36_SROA_3_0_P_SROA_IDX]], align 8, !tbaa {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[AGG_TEMP36_SROA_0_0_COPYLOAD]], i64 16
// CHECK-OBJC-NEXT:    [[TMP1:%.*]] = icmp ule ptr [[TMP0]], [[AGG_TEMP36_SROA_2_0_COPYLOAD]], !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[TMP2:%.*]] = icmp ule ptr [[AGG_TEMP36_SROA_3_0_COPYLOAD]], [[AGG_TEMP36_SROA_0_0_COPYLOAD]], !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[OR_COND:%.*]] = select i1 [[TMP1]], i1 [[TMP2]], i1 false, !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    br i1 [[OR_COND]], label %[[CONT44:.*]], label %[[TRAP:.*]], !prof {{![0-9]+}}, !annotation {{![0-9]+}}
// CHECK-OBJC:       [[TRAP]]:
// CHECK-OBJC-NEXT:    tail call void @llvm.ubsantrap(i8 25) #[[ATTR5]], !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    unreachable, !annotation {{![0-9]+}}
// CHECK-OBJC:       [[CONT44]]:
// CHECK-OBJC-NEXT:    [[PTR:%.*]] = getelementptr inbounds nuw i8, ptr [[AGG_TEMP36_SROA_0_0_COPYLOAD]], i64 8
// CHECK-OBJC-NEXT:    store ptr [[CALL]], ptr [[PTR]], align 8, !tbaa {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[AGG_TEMP45_SROA_0_0_COPYLOAD:%.*]] = load ptr, ptr [[P]], align 8
// CHECK-OBJC-NEXT:    [[AGG_TEMP45_SROA_2_0_COPYLOAD:%.*]] = load ptr, ptr [[AGG_TEMP36_SROA_2_0_P_SROA_IDX]], align 8
// CHECK-OBJC-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[AGG_TEMP45_SROA_0_0_COPYLOAD]], i64 16
// CHECK-OBJC-NEXT:    [[TMP4:%.*]] = icmp ule ptr [[TMP3]], [[AGG_TEMP45_SROA_2_0_COPYLOAD]], !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[TMP5:%.*]] = icmp ule ptr [[AGG_TEMP36_SROA_3_0_COPYLOAD]], [[AGG_TEMP45_SROA_0_0_COPYLOAD]], !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[OR_COND54:%.*]] = select i1 [[TMP4]], i1 [[TMP5]], i1 false, !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    br i1 [[OR_COND54]], label %[[CONT53:.*]], label %[[TRAP]], !prof {{![0-9]+}}, !annotation {{![0-9]+}}
// CHECK-OBJC:       [[CONT53]]:
// CHECK-OBJC-NEXT:    store i32 11, ptr [[AGG_TEMP45_SROA_0_0_COPYLOAD]], align 8, !tbaa {{![0-9]+}}
// CHECK-OBJC-NEXT:    ret void
//
...
// CHECK-NEXT:    ret void
//
// CHECK-OBJC-LABEL: define dso_local void @shared_flexbase_update(
// CHECK-OBJC-SAME: ptr noundef readonly captures(none) [[P:%.*]]) local_unnamed_addr #[[ATTR2]] {
// CHECK-OBJC-NEXT:  [[ENTRY:.*:]]
// CHECK-OBJC-NEXT:    [[CALL:%.*]] = tail call ptr @baz(i32 noundef 11) #[[ATTR6]]
// CHECK-OBJC-NEXT:    [[P2_SROA_0_0_COPYLOAD:%.*]] = load ptr, ptr [[P]], align 8
// CHECK-OBJC-NEXT:    [[P2_SROA_5_0_P_SROA_IDX:%.*]] = getelementptr inbounds nuw i8, ptr [[P]], i64 8
// CHECK-OBJC-NEXT:    [[P2_SROA_5_0_COPYLOAD:%.*]] = load ptr, ptr [[P2_SROA_5_0_P_SROA_IDX]], align 8
// CHECK-OBJC-NEXT:    [[P2_SROA_7_0_P_SROA_IDX:%.*]] = getelementptr inbounds nuw i8, ptr [[P]], i64 16
// CHECK-OBJC-NEXT:    [[P2_SROA_7_0_COPYLOAD:%.*]] = load ptr, ptr [[P2_SROA_7_0_P_SROA_IDX]], align 8, !tbaa {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[P2_SROA_0_0_COPYLOAD]], i64 16
// CHECK-OBJC-NEXT:    [[TMP1:%.*]] = icmp ule ptr [[TMP0]], [[P2_SROA_5_0_COPYLOAD]], !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[TMP2:%.*]] = icmp ule ptr [[P2_SROA_7_0_COPYLOAD]], [[P2_SROA_0_0_COPYLOAD]], !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[OR_COND:%.*]] = select i1 [[TMP1]], i1 [[TMP2]], i1 false, !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    br i1 [[OR_COND]], label %[[CONT44:.*]], label %[[TRAP:.*]], !prof {{![0-9]+}}, !annotation {{![0-9]+}}
// CHECK-OBJC:       [[TRAP]]:
// CHECK-OBJC-NEXT:    tail call void @llvm.ubsantrap(i8 25) #[[ATTR5]], !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    unreachable, !annotation {{![0-9]+}}
// CHECK-OBJC:       [[CONT44]]:
// CHECK-OBJC-NEXT:    [[PTR:%.*]] = getelementptr inbounds nuw i8, ptr [[P2_SROA_0_0_COPYLOAD]], i64 8
// CHECK-OBJC-NEXT:    store ptr [[CALL]], ptr [[PTR]], align 8, !tbaa {{![0-9]+}}
// CHECK-OBJC-NEXT:    store i32 11, ptr [[P2_SROA_0_0_COPYLOAD]], align 8, !tbaa {{![0-9]+}}
// CHECK-OBJC-NEXT:    ret void
//
...
// CHECK-NEXT:    ret void
//
// CHECK-OBJC-LABEL: define dso_local void @shared_flexbase_update_reverse(
// CHECK-OBJC-SAME: ptr noundef readonly captures(none) [[P:%.*]]) local_unnamed_addr #[[ATTR2]] {
// CHECK-OBJC-NEXT:  [[ENTRY:.*:]]
// CHECK-OBJC-NEXT:    [[CALL:%.*]] = tail call ptr @baz(i32 noundef 11) #[[ATTR6]]
// CHECK-OBJC-NEXT:    [[P2_SROA_0_0_COPYLOAD:%.*]] = load ptr, ptr [[P]], align 8
...
// CHECK-NEXT:    ret void
//
// CHECK-OBJC-LABEL: define dso_local void @shared_flexbase_self_assign(
// CHECK-OBJC-SAME: ptr noundef readonly captures(none) [[P:%.*]]) local_unnamed_addr #[[ATTR2]] {
// CHECK-OBJC-NEXT:  [[ENTRY:.*:]]
// CHECK-OBJC-NEXT:    [[CALL:%.*]] = tail call ptr @baz(i32 noundef 11) #[[ATTR6]]
// CHECK-OBJC-NEXT:    [[AGG_TEMP36_SROA_0_0_COPYLOAD:%.*]] = load ptr, ptr [[P]], align 8
...
// CHECK-NEXT:    ret void
//
// CHECK-OBJC-LABEL: define dso_local void @shared_flexbase_self_assign_reverse(
// CHECK-OBJC-SAME: ptr noundef readonly captures(none) [[P:%.*]]) local_unnamed_addr #[[ATTR2]] {
// CHECK-OBJC-NEXT:  [[ENTRY:.*:]]
// CHECK-OBJC-NEXT:    [[CALL:%.*]] = tail call ptr @baz(i32 noundef 11) #[[ATTR6]]
// CHECK-OBJC-NEXT:    [[AGG_TEMP29_SROA_0_0_COPYLOAD:%.*]] = load ptr, ptr [[P]], align 8
...
// CHECK-SAME: ptr noundef readonly captures(none) [[P:%.*]]) local_unnamed_addr #[[ATTR4:[0-9]+]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
...
// CHECK-NEXT:    ret void
//
// CHECK-OBJC-LABEL: define dso_local void @shared_flexbase_self_assign_fr(
// CHECK-OBJC-SAME: ptr noundef readonly captures(none) [[P:%.*]]) local_unnamed_addr #[[ATTR4:[0-9]+]] {
// CHECK-OBJC-NEXT:  [[ENTRY:.*:]]
// CHECK-OBJC-NEXT:    [[AGG_TEMP1_SROA_0_0_COPYLOAD:%.*]] = load ptr, ptr [[P]], align 8
// CHECK-OBJC-NEXT:    [[AGG_TEMP1_SROA_2_0_P_SROA_IDX:%.*]] = getelementptr inbounds nuw i8, ptr [[P]], i64 8
// CHECK-OBJC-NEXT:    [[AGG_TEMP1_SROA_2_0_COPYLOAD:%.*]] = load ptr, ptr [[AGG_TEMP1_SROA_2_0_P_SROA_IDX]], align 8
// CHECK-OBJC-NEXT:    [[AGG_TEMP1_SROA_3_0_P_SROA_IDX:%.*]] = getelementptr inbounds nuw i8, ptr [[P]], i64 16
// CHECK-OBJC-NEXT:    [[AGG_TEMP1_SROA_3_0_COPYLOAD:%.*]] = load ptr, ptr [[AGG_TEMP1_SROA_3_0_P_SROA_IDX]], align 8, !tbaa {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[AGG_TEMP1_SROA_0_0_COPYLOAD]], i64 16
...
// CHECK-OBJC-NEXT:    [[OR_COND:%.*]] = select i1 [[TMP1]], i1 [[TMP2]], i1 false, !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    br i1 [[OR_COND]], label %[[CONT11:.*]], label %[[TRAP:.*]], !prof {{![0-9]+}}, !annotation {{![0-9]+}}
// CHECK-OBJC:       [[TRAP]]:
// CHECK-OBJC-NEXT:    tail call void @llvm.ubsantrap(i8 25) #[[ATTR5]], !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    unreachable, !annotation {{![0-9]+}}
// CHECK-OBJC:       [[CONT11]]:
// CHECK-OBJC-NEXT:    [[TMP3:%.*]] = load i32, ptr [[AGG_TEMP1_SROA_0_0_COPYLOAD]], align 8, !tbaa {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[CMP43:%.*]] = icmp sgt i32 [[TMP3]], 10, !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    br i1 [[CMP43]], label %[[CONT72:.*]], label %[[TRAP]], !prof {{![0-9]+}}, !annotation {{![0-9]+}}
// CHECK-OBJC:       [[CONT72]]:
// CHECK-OBJC-NEXT:    store i32 11, ptr [[AGG_TEMP1_SROA_0_0_COPYLOAD]], align 8, !tbaa {{![0-9]+}}
// CHECK-OBJC-NEXT:    ret void
//
...
// CHECK-SAME: ptr noundef readonly captures(none) [[P:%.*]]) local_unnamed_addr #[[ATTR4]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[AGG_TEMP1_SROA_0_0_COPYLOAD:%.*]] = load ptr, ptr [[P]], align 8
// CHECK-NEXT:    [[AGG_TEMP1_SROA_2_0_P_SROA_IDX:%.*]] = getelementptr inbounds nuw i8, ptr [[P]], i64 8
// CHECK-NEXT:    [[AGG_TEMP1_SROA_2_0_COPYLOAD:%.*]] = load ptr, ptr [[AGG_TEMP1_SROA_2_0_P_SROA_IDX]], align 8
...
// CHECK-NEXT:    ret void
//
// CHECK-OBJC-LABEL: define dso_local void @shared_flexbase_self_assign_fr_reverse(
// CHECK-OBJC-SAME: ptr noundef readonly captures(none) [[P:%.*]]) local_unnamed_addr #[[ATTR4]] {
// CHECK-OBJC-NEXT:  [[ENTRY:.*:]]
// CHECK-OBJC-NEXT:    [[AGG_TEMP1_SROA_0_0_COPYLOAD:%.*]] = load ptr, ptr [[P]], align 8
// CHECK-OBJC-NEXT:    [[AGG_TEMP1_SROA_2_0_P_SROA_IDX:%.*]] = getelementptr inbounds nuw i8, ptr [[P]], i64 8
// CHECK-OBJC-NEXT:    [[AGG_TEMP1_SROA_2_0_COPYLOAD:%.*]] = load ptr, ptr [[AGG_TEMP1_SROA_2_0_P_SROA_IDX]], align 8
...
// CHECK-OBJC:       [[CONT11]]:
// CHECK-OBJC-NEXT:    [[TMP3:%.*]] = load i32, ptr [[AGG_TEMP1_SROA_0_0_COPYLOAD]], align 8, !tbaa {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[PTR:%.*]] = getelementptr inbounds nuw i8, ptr [[AGG_TEMP1_SROA_0_0_COPYLOAD]], i64 8
// CHECK-OBJC-NEXT:    [[TMP4:%.*]] = load ptr, ptr [[PTR]], align 8, !tbaa {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[CMP43:%.*]] = icmp sgt i32 [[TMP3]], 10, !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    br i1 [[CMP43]], label %[[CONT55:.*]], label %[[TRAP]], !prof {{![0-9]+}}, !annotation {{![0-9]+}}
// CHECK-OBJC:       [[CONT55]]:
// CHECK-OBJC-NEXT:    store i32 11, ptr [[AGG_TEMP1_SROA_0_0_COPYLOAD]], align 8, !tbaa {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[AGG_TEMP64_SROA_0_0_COPYLOAD:%.*]] = load ptr, ptr [[P]], align 8
// CHECK-OBJC-NEXT:    [[AGG_TEMP64_SROA_2_0_COPYLOAD:%.*]] = load ptr, ptr [[AGG_TEMP1_SROA_2_0_P_SROA_IDX]], align 8
// CHECK-OBJC-NEXT:    [[TMP5:%.*]] = getelementptr i8, ptr [[AGG_TEMP64_SROA_0_0_COPYLOAD]], i64 16
// CHECK-OBJC-NEXT:    [[TMP6:%.*]] = icmp ule ptr [[TMP5]], [[AGG_TEMP64_SROA_2_0_COPYLOAD]], !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[TMP7:%.*]] = icmp ule ptr [[AGG_TEMP1_SROA_3_0_COPYLOAD]], [[AGG_TEMP64_SROA_0_0_COPYLOAD]], !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[OR_COND76:%.*]] = select i1 [[TMP6]], i1 [[TMP7]], i1 false, !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    br i1 [[OR_COND76]], label %[[CONT72:.*]], label %[[TRAP]], !prof {{![0-9]+}}, !annotation {{![0-9]+}}
// CHECK-OBJC:       [[CONT72]]:
// CHECK-OBJC-NEXT:    [[PTR73:%.*]] = getelementptr inbounds nuw i8, ptr [[AGG_TEMP64_SROA_0_0_COPYLOAD]], i64 8
// CHECK-OBJC-NEXT:    store ptr [[TMP4]], ptr [[PTR73]], align 8, !tbaa {{![0-9]+}}
// CHECK-OBJC-NEXT:    ret void
//
...
// CHECK-NEXT:    ret void
//
// CHECK-OBJC-LABEL: define dso_local void @double_no_flexbase_update_once(
// CHECK-OBJC-SAME: ptr noundef readonly captures(none) [[P:%.*]]) local_unnamed_addr #[[ATTR0]] {
// CHECK-OBJC-NEXT:  [[ENTRY:.*:]]
// CHECK-OBJC-NEXT:    [[AGG_TEMP_SROA_0_0_COPYLOAD:%.*]] = load ptr, ptr [[P]], align 8
// CHECK-OBJC-NEXT:    [[AGG_TEMP_SROA_2_0_P_SROA_IDX:%.*]] = getelementptr inbounds nuw i8, ptr [[P]], i64 8
...
// CHECK-OBJC-NEXT:    [[AGG_TEMP_SROA_3_0_P_SROA_IDX:%.*]] = getelementptr inbounds nuw i8, ptr [[P]], i64 16
// CHECK-OBJC-NEXT:    [[AGG_TEMP_SROA_3_0_COPYLOAD:%.*]] = load ptr, ptr [[AGG_TEMP_SROA_3_0_P_SROA_IDX]], align 8, !tbaa {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[AGG_TEMP_SROA_0_0_COPYLOAD]], i64 8
// CHECK-OBJC-NEXT:    [[TMP1:%.*]] = icmp ule ptr [[TMP0]], [[AGG_TEMP_SROA_2_0_COPYLOAD]], !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[TMP2:%.*]] = icmp ule ptr [[AGG_TEMP_SROA_3_0_COPYLOAD]], [[AGG_TEMP_SROA_0_0_COPYLOAD]], !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[OR_COND:%.*]] = select i1 [[TMP1]], i1 [[TMP2]], i1 false, !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    br i1 [[OR_COND]], label %[[CONT1:.*]], label %[[TRAP:.*]], !prof {{![0-9]+}}, !annotation {{![0-9]+}}
...
// CHECK-NEXT:    ret void
//
// CHECK-OBJC-LABEL: define dso_local void @double_no_flexbase_update_both(
// CHECK-OBJC-SAME: ptr noundef readonly captures(none) [[P:%.*]]) local_unnamed_addr #[[ATTR0]] {
// CHECK-OBJC-NEXT:  [[ENTRY:.*:]]
// CHECK-OBJC-NEXT:    [[AGG_TEMP_SROA_0_0_COPYLOAD:%.*]] = load ptr, ptr [[P]], align 8
// CHECK-OBJC-NEXT:    [[AGG_TEMP_SROA_2_0_P_SROA_IDX:%.*]] = getelementptr inbounds nuw i8, ptr [[P]], i64 8
...
// CHECK-OBJC:       [[CONT1]]:
// CHECK-OBJC-NEXT:    store i32 11, ptr [[AGG_TEMP_SROA_0_0_COPYLOAD]], align 4, !tbaa {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[AGG_TEMP2_SROA_0_0_COPYLOAD:%.*]] = load ptr, ptr [[P]], align 8
// CHECK-OBJC-NEXT:    [[AGG_TEMP2_SROA_2_0_COPYLOAD:%.*]] = load ptr, ptr [[AGG_TEMP_SROA_2_0_P_SROA_IDX]], align 8
// CHECK-OBJC-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[AGG_TEMP2_SROA_0_0_COPYLOAD]], i64 8
// CHECK-OBJC-NEXT:    [[TMP4:%.*]] = icmp ule ptr [[TMP3]], [[AGG_TEMP2_SROA_2_0_COPYLOAD]], !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[TMP5:%.*]] = icmp ule ptr [[AGG_TEMP_SROA_3_0_COPYLOAD]], [[AGG_TEMP2_SROA_0_0_COPYLOAD]], !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    [[OR_COND11:%.*]] = select i1 [[TMP4]], i1 [[TMP5]], i1 false, !annotation {{![0-9]+}}
// CHECK-OBJC-NEXT:    br i1 [[OR_COND11]], label %[[CONT10:.*]], label %[[TRAP]], !prof {{![0-9]+}}, !annotation {{![0-9]+}}
// CHECK-OBJC:       [[CONT10]]:
// CHECK-OBJC-NEXT:    [[LEN2:%.*]] = getelementptr inbounds nuw i8, ptr [[AGG_TEMP2_SROA_0_0_COPYLOAD]], i64 4
// CHECK-OBJC-NEXT:    store i32 11, ptr [[LEN2]], align 4, !tbaa {{![0-9]+}}
// CHECK-OBJC-NEXT:    ret void
//
