...
// CHECK:       [[CONT53]]:
// CHECK-NEXT:    [[PTR:%.*]] = getelementptr inbounds i8, ptr [[AGG_TEMP45_SROA_0_0_COPYLOAD]], i64 8
...
// CHECK-NEXT:    unreachable, !annotation [[META11]]
// CHECK:       [[CONT44]]:
// CHECK-NEXT:    [[PTR:%.*]] = getelementptr inbounds i8, ptr [[AGG_TEMP36_SROA_0_0_COPYLOAD]], i64 8
// CHECK-NEXT:    store ptr [[CALL]], ptr [[PTR]], align 8, !tbaa [[TBAA2]]
// CHECK-NEXT:    [[AGG_TEMP45_SROA_0_0_COPYLOAD:%.*]] = load ptr, ptr [[P]], align 8
...
// CHECK-NEXT:    unreachable, !annotation [[META11]]
// CHECK:       [[CONT44]]:
// CHECK-NEXT:    [[PTR:%.*]] = getelementptr inbounds i8, ptr [[P2_SROA_0_0_COPYLOAD]], i64 8
// CHECK-NEXT:    store ptr [[CALL]], ptr [[PTR]], align 8, !tbaa [[TBAA2]]
...
// CHECK:       [[CONT12]]:
// CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[AGG_TEMP1_SROA_0_0_COPYLOAD]], align 8, !tbaa [[TBAA9]]
// CHECK-NEXT:    [[PTR:%.*]] = getelementptr inbounds i8, ptr [[AGG_TEMP1_SROA_0_0_COPYLOAD]], i64 8
...
// CHECK:       [[CONT73]]:
// CHECK-NEXT:    [[PTR74:%.*]] = getelementptr inbounds i8, ptr [[AGG_TEMP65_SROA_0_0_COPYLOAD]], i64 8
...
// CHECK:       [[CONT10]]:
// CHECK-NEXT:    [[LEN2:%.*]] = getelementptr inbounds i8, ptr [[AGG_TEMP2_SROA_0_0_COPYLOAD]], i64 4
