...
// RUN: %clang_cc1 -O0 -triple arm64-apple-ios -fbounds-safety -fno-bounds-safety-bringup-missing-checks=return_size -emit-llvm %s -o - | FileCheck --check-prefix=LEGACY %s
...
// CHECK-LABEL: define void @use_inline_header_func_unspecified_ptr(
...
// CHECK-NEXT:    call void @consume(ptr nofreeobj noundef align 8 dead_on_return dereferenceable(24) [[BYVAL_TEMP]])
// CHECK-NEXT:    ret void
//
// LEGACY-LABEL: define void @use_inline_header_func_unspecified_ptr(
...
// LEGACY-NEXT:    call void @consume(ptr nofreeobj noundef align 8 dead_on_return dereferenceable(24) [[BYVAL_TEMP]])
...
// CHECK-LABEL: define void @use_inline_header_func_unsafe_indexable_ptr(
...
// CHECK-NEXT:    ret void
//
// LEGACY-LABEL: define void @use_inline_header_func_unsafe_indexable_ptr(
