...
// CHECK-NEXT:    call void @consume(ptr nofree noundef align 8 dead_on_return dereferenceable(24) [[BYVAL_TEMP]])
// CHECK-NEXT:    ret void
//
...
// LEGACY-NEXT:    call void @consume(ptr nofree noundef align 8 dead_on_return dereferenceable(24) [[BYVAL_TEMP]])
