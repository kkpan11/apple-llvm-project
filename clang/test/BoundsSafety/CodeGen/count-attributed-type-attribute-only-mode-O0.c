...
// RUN: %clang_cc1 -O0 -triple arm64-apple-ios -x c -emit-llvm %s -o - | FileCheck %s
// RUN: %clang_cc1 -O0 -triple arm64-apple-ios -fexperimental-bounds-safety-attributes -x c -emit-llvm %s -o - | FileCheck %s
// RUN: %clang_cc1 -O0 -triple arm64-apple-ios -fexperimental-bounds-safety-attributes -x c++ -emit-llvm %s -o - | FileCheck %s
// RUN: %clang_cc1 -O0 -triple arm64-apple-ios -fexperimental-bounds-safety-attributes -x objective-c -emit-llvm %s -o - | FileCheck %s
// RUN: %clang_cc1 -O0 -triple arm64-apple-ios -fexperimental-bounds-safety-attributes -x objective-c++ -emit-llvm %s -o - | FileCheck %s
...
// CHECK-LABEL: define i32 @fn_deref(
...
// CHECK-LABEL: define i32 @fn_subscript(
...
// CHECK-LABEL: define ptr @fn_assign(
// CHECK-SAME: ptr noundef [[P:%.*]], i32 noundef [[COUNT:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[P_ADDR:%.*]] = alloca ptr, align 8
// CHECK-NEXT:    [[COUNT_ADDR:%.*]] = alloca i32, align 4
...
// CHECK-LABEL: define i32 @struct_deref(
...
// CHECK-LABEL: define i32 @struct_subscript(
// CHECK-SAME: ptr noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[B_ADDR:%.*]] = alloca ptr, align 8
// CHECK-NEXT:    store ptr [[B]], ptr [[B_ADDR]], align 8
...
// CHECK-LABEL: define void @struct_assign(
// CHECK-SAME: ptr noundef [[B:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[B_ADDR:%.*]] = alloca ptr, align 8
// CHECK-NEXT:    store ptr [[B]], ptr [[B_ADDR]], align 8
