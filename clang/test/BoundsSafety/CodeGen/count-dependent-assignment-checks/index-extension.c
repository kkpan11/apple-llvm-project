...
// RUN: %clang_cc1 -O2  -triple arm64-apple-ios -fbounds-safety -emit-llvm %s -o - | FileCheck %s --check-prefix=CHECK

#include <ptrcheck.h>

// CHECK-LABEL: define void @idx_char(
...
// CHECK-LABEL: define void @idx_unsigned_char(
...
// CHECK-LABEL: define void @idx_short_int(
...
// CHECK-LABEL: define void @idx_short_unsigned(
// CHECK-SAME: ptr nofree noundef writeonly captures(address) [[DST:%.*]], i32 noundef [[N:%.*]], i16 noundef [[IDX:%.*]]) local_unnamed_addr #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[IDX_EXT:%.*]] = zext i32 [[N]] to i64
// CHECK-NEXT:    [[ADD_PTR:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[DST]], i64 [[IDX_EXT]]
...
// CHECK-LABEL: define void @idx_int(
...
// CHECK-LABEL: define void @idx_unsigned(
// CHECK-SAME: ptr nofree noundef writeonly captures(address) [[DST:%.*]], i32 noundef [[N:%.*]], i32 noundef [[IDX:%.*]]) local_unnamed_addr #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[IDX_EXT:%.*]] = zext i32 [[N]] to i64
// CHECK-NEXT:    [[ADD_PTR:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[DST]], i64 [[IDX_EXT]]
...
// CHECK-LABEL: define void @idx_long_int(
...
// CHECK-LABEL: define void @idx_long_unsigned(
// CHECK-SAME: ptr nofree noundef writeonly captures(address) [[DST:%.*]], i32 noundef [[N:%.*]], i64 noundef [[IDX:%.*]]) local_unnamed_addr #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[IDX_EXT:%.*]] = zext i32 [[N]] to i64
// CHECK-NEXT:    [[ADD_PTR:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[DST]], i64 [[IDX_EXT]]
...
// CHECK-LABEL: define void @idx_long_unsigned_counted_by_int(
// CHECK-SAME: ptr nofree noundef writeonly captures(address) [[DST:%.*]], i32 noundef [[N:%.*]], i64 noundef [[IDX:%.*]]) local_unnamed_addr #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
