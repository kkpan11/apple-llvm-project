...
// CHECK-NEXT:    [[ITER52:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[S]], i32 0, i32 0
...
// CHECK-NEXT:    [[START58:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[S]], i32 0, i32 2
// CHECK-NEXT:    [[TMP33:%.*]] = load ptr, ptr [[START58]], align 8
// CHECK-NEXT:    [[END59:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[S]], i32 0, i32 1
...
// CHECK-NEXT:    [[ITER64:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[S]], i32 0, i32 0
