...
// UBSAN-NEXT:    [[CMP_NOT:%.*]] = icmp ult ptr [[TMP1]], [[DEROUT]], {{!annotation ![0-9]+}}
...
// NOUBSAN-NEXT:    [[CMP_NOT:%.*]] = icmp ult ptr [[TMP1]], [[DEROUT]], {{!annotation ![0-9]+}}
...
// UBSAN-NEXT:    [[TMP1:%.*]] = add i64 [[TMP0]], [[OFFSET]], {{!nosanitize ![0-9]+}}
...
// UBSAN-NEXT:    [[CMP44_NOT:%.*]] = icmp ult i64 [[SUB_PTR_SUB]], [[LEN:%.*]], {{!annotation ![0-9]+}}
...
// NOUBSAN-NEXT:    [[CMP44_NOT:%.*]] = icmp ult i64 [[SUB_PTR_SUB]], [[LEN:%.*]], {{!annotation ![0-9]+}}
