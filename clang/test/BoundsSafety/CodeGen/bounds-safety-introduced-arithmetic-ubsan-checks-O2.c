...
// UBSAN-NEXT:    [[TMP0:%.*]] = ptrtoaddr ptr [[TMP_SROA_0_0_COPYLOAD]] to i64, {{!nosanitize ![0-9]+}}
...
// UBSAN-NEXT:    br i1 [[TMP6]], label %[[CONT:.*]], label %[[TRAP:.*]], {{!prof ![0-9]+}}, {{!nosanitize ![0-9]+}}
// UBSAN:       [[TRAP]]:
...
// UBSAN-NEXT:    br i1 [[OR_COND55]], label %[[TRAP45:.*]], label %[[CONT46:.*]], {{!prof ![0-9]+}}, {{!annotation ![0-9]+}}
// UBSAN:       [[TRAP45]]:
...
// NOUBSAN-NEXT:    br i1 [[OR_COND52]], label %[[TRAP:.*]], label %[[CONT:.*]], {{!prof ![0-9]+}}, {{!annotation ![0-9]+}}
// NOUBSAN:       [[TRAP]]:
