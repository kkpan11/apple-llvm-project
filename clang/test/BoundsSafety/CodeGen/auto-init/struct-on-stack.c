...
int main(int argc, char **argv) {
  struct Foo f;
// CHECK: [[FOO_SINGLE:%.*]] = getelementptr inbounds %struct.Foo, ptr [[FOO_F:%.*]], i32 0, i32 0
// CHECK: store ptr null, ptr [[FOO_SINGLE]]{{.*}} !annotation ![[ANNOT_ZERO_INIT:[0-9]+]]
// CHECK: [[FOO_INDEXABLE:%.*]] = getelementptr inbounds %struct.Foo, ptr [[FOO_F]], i32 0, i32 1
// CHECK: call void @llvm.memset.p0.i64(ptr align 8 [[FOO_INDEXABLE]], i8 0, i64 16, i1 false){{.*}} !annotation ![[ANNOT_ZERO_INIT:[0-9]+]]
// CHECK: [[FOO_BIDI_INDEX:%.*]] = getelementptr inbounds %struct.Foo, ptr [[FOO_F]], i32 0, i32 2
// CHECK: call void @llvm.memset.p0.i64(ptr align 8 [[FOO_BIDI_INDEX]], i8 0, i64 24, i1 false){{.*}} !annotation ![[ANNOT_ZERO_INIT]]
// CHECK: getelementptr inbounds %struct.Foo, ptr [[FOO_F]], i32 0, i32 3
// CHECK: [[FOO_SINGLE_COUNTED_BY:%.*]] = getelementptr inbounds %struct.Foo, ptr [[FOO_F]], i32 0, i32 4
