...
// RUN: %clang_cc1 -O0 -triple arm64-apple-ios -fbounds-safety -x objective-c -fexperimental-bounds-safety-objc -emit-llvm %s -o - | FileCheck %s
...
// CHECK-NEXT:    [[TMP12:%.*]] = getelementptr [[STRUCT_OUTER]], ptr [[WIDE_PTR_PTR30]], i64 1, !annotation [[META10:![0-9]+]]
// CHECK-NEXT:    [[TMP13:%.*]] = icmp ule ptr [[TMP12]], [[WIDE_PTR_UB32]], !annotation [[META10]]
// CHECK-NEXT:    br i1 [[TMP13]], label %[[CONT36:.*]], label %[[TRAP35:.*]], {{!prof ![0-9]+}}, !annotation [[META10]]
// CHECK:       [[TRAP35]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], !annotation [[META10]]
// CHECK-NEXT:    unreachable, !annotation [[META10]]
// CHECK:       [[CONT36]]:
// CHECK-NEXT:    [[TMP14:%.*]] = icmp ule ptr [[WIDE_PTR_PTR30]], [[TMP12]], !annotation [[META10]]
// CHECK-NEXT:    br i1 [[TMP14]], label %[[CONT38:.*]], label %[[TRAP37:.*]], {{!prof ![0-9]+}}, !annotation [[META10]]
// CHECK:       [[TRAP37]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], !annotation [[META10]]
// CHECK-NEXT:    unreachable, !annotation [[META10]]
// CHECK:       [[CONT38]]:
// CHECK-NEXT:    [[TMP15:%.*]] = icmp uge ptr [[WIDE_PTR_PTR30]], [[WIDE_PTR_LB34]], !annotation [[META3]]
// CHECK-NEXT:    br i1 [[TMP15]], label %[[CONT40:.*]], label %[[TRAP39:.*]], {{!prof ![0-9]+}}, !annotation [[META3]]
// CHECK:       [[TRAP39]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], !annotation [[META3]]
// CHECK-NEXT:    unreachable, !annotation [[META3]]
// CHECK:       [[CONT40]]:
...
// CHECK-NEXT:    [[TMP18:%.*]] = icmp ne ptr [[TMP17]], null, !annotation [[META4]]
// CHECK-NEXT:    br i1 [[TMP18]], label %[[BOUNDSCHECK_NOTNULL43:.*]], label %[[BOUNDSCHECK_NULL48:.*]], !annotation [[META4]]
...
// CHECK-NEXT:    [[WIDE_PTR_PTR_ADDR49:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable.0", ptr [[AGG_TEMP42]], i32 0, i32 0
// CHECK-NEXT:    [[WIDE_PTR_PTR50:%.*]] = load ptr, ptr [[WIDE_PTR_PTR_ADDR49]], align 8
// CHECK-NEXT:    [[WIDE_PTR_UB_ADDR51:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable.0", ptr [[AGG_TEMP42]], i32 0, i32 1
// CHECK-NEXT:    [[WIDE_PTR_UB52:%.*]] = load ptr, ptr [[WIDE_PTR_UB_ADDR51]], align 8
// CHECK-NEXT:    [[WIDE_PTR_LB_ADDR53:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable.0", ptr [[AGG_TEMP42]], i32 0, i32 2
// CHECK-NEXT:    [[WIDE_PTR_LB54:%.*]] = load ptr, ptr [[WIDE_PTR_LB_ADDR53]], align 8
// CHECK-NEXT:    [[TMP26:%.*]] = icmp ne ptr [[WIDE_PTR_PTR50]], null, !annotation [[META4]]
// CHECK-NEXT:    br i1 [[TMP26]], label %[[BOUNDSCHECK_NOTNULL55:.*]], label %[[BOUNDSCHECK_NULL62:.*]], !annotation [[META4]]
// CHECK:       [[BOUNDSCHECK_NOTNULL55]]:
// CHECK-NEXT:    [[TMP27:%.*]] = getelementptr [[STRUCT_OUTER]], ptr [[WIDE_PTR_PTR50]], i64 1, !annotation [[META10]]
// CHECK-NEXT:    [[TMP28:%.*]] = icmp ule ptr [[TMP27]], [[WIDE_PTR_UB52]], !annotation [[META10]]
// CHECK-NEXT:    br i1 [[TMP28]], label %[[CONT57:.*]], label %[[TRAP56:.*]], {{!prof ![0-9]+}}, !annotation [[META10]]
// CHECK:       [[TRAP56]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], !annotation [[META10]]
// CHECK-NEXT:    unreachable, !annotation [[META10]]
// CHECK:       [[CONT57]]:
// CHECK-NEXT:    [[TMP29:%.*]] = icmp ule ptr [[WIDE_PTR_PTR50]], [[TMP27]], !annotation [[META10]]
// CHECK-NEXT:    br i1 [[TMP29]], label %[[CONT59:.*]], label %[[TRAP58:.*]], {{!prof ![0-9]+}}, !annotation [[META10]]
// CHECK:       [[TRAP58]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], !annotation [[META10]]
// CHECK-NEXT:    unreachable, !annotation [[META10]]
// CHECK:       [[CONT59]]:
// CHECK-NEXT:    [[TMP30:%.*]] = icmp uge ptr [[WIDE_PTR_PTR50]], [[WIDE_PTR_LB54]], !annotation [[META3]]
// CHECK-NEXT:    br i1 [[TMP30]], label %[[CONT61:.*]], label %[[TRAP60:.*]], {{!prof ![0-9]+}}, !annotation [[META3]]
// CHECK:       [[TRAP60]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], !annotation [[META3]]
// CHECK-NEXT:    unreachable, !annotation [[META3]]
// CHECK:       [[CONT61]]:
// CHECK-NEXT:    br label %[[BOUNDSCHECK_NULL62]]
// CHECK:       [[BOUNDSCHECK_NULL62]]:
// CHECK-NEXT:    ret ptr [[WIDE_PTR_PTR50]]
//
...
// CHECK: [[META10]] = !{!"bounds-safety-check-ptr-le-upper-bound"}
//.
