...
// CHECK-LABEL: define noundef ptr @cb_in_from_indexable(
...
// CHECK-NEXT:    br i1 [[CMP_NOT]], label %[[TRAP:.*]], label %[[LAND_RHS:.*]], !annotation [[META6]]
// CHECK:       [[LAND_RHS]]:
// CHECK-NEXT:    [[SUB_PTR_LHS_CAST:%.*]] = ptrtoaddr ptr [[TMP_SROA_9_0]] to i64, !annotation [[META6]]
// CHECK-NEXT:    [[SUB_PTR_RHS_CAST:%.*]] = ptrtoaddr ptr [[P]] to i64, !annotation [[META6]]
...
// CHECK-LABEL: define noundef ptr @sb_in_from_single(
