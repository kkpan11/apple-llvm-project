...
// RUN: %clang_cc1 -O0 -triple arm64-apple-ios -fbounds-safety -emit-llvm %s -o - | FileCheck %s
...
// CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[AGG_TEMP5]], ptr align 8 [[AGG_TEMP4]], i64 24, i1 false), !annotation [[META1:![0-9]+]]
// CHECK-NEXT:    [[WIDE_PTR_PTR_ADDR:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP5]], i32 0, i32 0, !annotation [[META1]]
// CHECK-NEXT:    [[WIDE_PTR_PTR:%.*]] = load ptr, ptr [[WIDE_PTR_PTR_ADDR]], align 8, !annotation [[META1]]
// CHECK-NEXT:    [[WIDE_PTR_UB_ADDR:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP5]], i32 0, i32 1, !annotation [[META1]]
// CHECK-NEXT:    [[WIDE_PTR_UB:%.*]] = load ptr, ptr [[WIDE_PTR_UB_ADDR]], align 8, !annotation [[META1]]
// CHECK-NEXT:    [[WIDE_PTR_LB_ADDR:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP5]], i32 0, i32 2, !annotation [[META1]]
// CHECK-NEXT:    [[WIDE_PTR_LB:%.*]] = load ptr, ptr [[WIDE_PTR_LB_ADDR]], align 8, !annotation [[META1]]
// CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[AGG_TEMP6]], ptr align 8 [[AGG_TEMP4]], i64 24, i1 false), !annotation [[META1]]
// CHECK-NEXT:    [[WIDE_PTR_UB_ADDR7:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP6]], i32 0, i32 1, !annotation [[META1]]
// CHECK-NEXT:    [[WIDE_PTR_UB8:%.*]] = load ptr, ptr [[WIDE_PTR_UB_ADDR7]], align 8, !annotation [[META1]]
// CHECK-NEXT:    [[CMP9:%.*]] = icmp ule ptr [[WIDE_PTR_PTR]], [[WIDE_PTR_UB8]], !annotation [[META1]]
// CHECK-NEXT:    br i1 [[CMP9]], label %[[LAND_LHS_TRUE:.*]], label %[[LAND_END39:.*]], !annotation [[META1]]
// CHECK:       [[LAND_LHS_TRUE]]:
// CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[AGG_TEMP11]], ptr align 8 [[AGG_TEMP4]], i64 24, i1 false), !annotation [[META1]]
...
// CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[AGG_TEMP14]], ptr align 8 [[AGG_TEMP4]], i64 24, i1 false), !annotation [[META1]]
...
// CHECK-NEXT:    [[CMP21:%.*]] = icmp ule ptr [[WIDE_PTR_LB13]], [[WIDE_PTR_PTR16]], !annotation [[META1]]
// CHECK-NEXT:    br i1 [[CMP21]], label %[[LAND_RHS:.*]], label %[[LAND_END39]], !annotation [[META1]]
// CHECK:       [[LAND_RHS]]:
// CHECK-NEXT:    [[CONV23:%.*]] = sext i32 [[TMP8]] to i64, !annotation [[META1]]
// CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[AGG_TEMP24]], ptr align 8 [[AGG_TEMP4]], i64 24, i1 false), !annotation [[META1]]
...
// CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[AGG_TEMP27]], ptr align 8 [[AGG_TEMP4]], i64 24, i1 false), !annotation [[META1]]
...
// CHECK-NEXT:    [[CMP34:%.*]] = icmp sle i64 [[CONV23]], [[SUB_PTR_DIV]], !annotation [[META1]]
// CHECK-NEXT:    br i1 [[CMP34]], label %[[LAND_RHS36:.*]], label %[[LAND_END:.*]], !annotation [[META1]]
// CHECK:       [[LAND_RHS36]]:
// CHECK-NEXT:    [[CMP37:%.*]] = icmp sle i32 0, [[TMP8]], !annotation [[META1]]
...
// CHECK-NEXT:    br i1 [[FLEX_BASE_NULL_CHECK]], label %[[FLEX_BASE_NONNULL:.*]], label %[[FLEX_BASE_NULL:.*]], !annotation [[META3]]
...
// CHECK-NEXT:    br i1 [[TMP12]], label %[[CONT49:.*]], label %[[TRAP48:.*]], {{!prof ![0-9]+}}, !annotation [[META4]]
// CHECK:       [[TRAP48]]:
...
// CHECK-NEXT:    br i1 [[TMP14]], label %[[CONT58:.*]], label %[[TRAP57:.*]], {{!prof ![0-9]+}}, !annotation [[META5]]
// CHECK:       [[TRAP57]]:
...
// CHECK-NEXT:    br i1 [[TMP15]], label %[[CONT60:.*]], label %[[TRAP59:.*]], {{!prof ![0-9]+}}, !annotation [[META6]]
// CHECK:       [[TRAP59]]:
...
// CHECK-NEXT:    br i1 [[FLEX_COUNT_MINUS]], label %[[CONT62:.*]], label %[[TRAP61:.*]], {{!prof ![0-9]+}}, !annotation [[META7]]
// CHECK:       [[TRAP61]]:
...
// CHECK-NEXT:    br i1 [[TMP16]], label %[[CONT64:.*]], label %[[TRAP63:.*]], {{!prof ![0-9]+}}, !annotation [[META8]]
// CHECK:       [[TRAP63]]:
...
// CHECK-NEXT:    br i1 [[TMP17]], label %[[CONT66:.*]], label %[[TRAP65:.*]], {{!prof ![0-9]+}}, !annotation [[META9]]
// CHECK:       [[TRAP65]]:
...
// CHECK-NEXT:    br i1 [[FLEX_COUNT_CHECK]], label %[[CONT68:.*]], label %[[TRAP67:.*]], {{!prof ![0-9]+}}, !annotation [[META10]]
// CHECK:       [[TRAP67]]:
...
// CHECK-NEXT:    br i1 [[TMP18]], label %[[BOUNDSCHECK_NOTNULL:.*]], label %[[BOUNDSCHECK_NULL:.*]], !annotation [[META3]]
...
// CHECK-NEXT:    br i1 [[TMP20]], label %[[CONT76:.*]], label %[[TRAP75:.*]], {{!prof ![0-9]+}}, !annotation [[META11]]
// CHECK:       [[TRAP75]]:
...
// CHECK-NEXT:    br i1 [[TMP21]], label %[[CONT78:.*]], label %[[TRAP77:.*]], {{!prof ![0-9]+}}, !annotation [[META11]]
// CHECK:       [[TRAP77]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR5]], !annotation [[META11]]
// CHECK-NEXT:    unreachable, !annotation [[META11]]
// CHECK:       [[CONT78]]:
// CHECK-NEXT:    [[TMP22:%.*]] = icmp uge ptr [[WIDE_PTR_PTR70]], [[WIDE_PTR_LB74]], !annotation [[META6]]
// CHECK-NEXT:    br i1 [[TMP22]], label %[[CONT80:.*]], label %[[TRAP79:.*]], {{!prof ![0-9]+}}, !annotation [[META6]]
// CHECK:       [[TRAP79]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR5]], !annotation [[META6]]
// CHECK-NEXT:    unreachable, !annotation [[META6]]
// CHECK:       [[CONT80]]:
...
// CHECK-NEXT:    [[HDR:%.*]] = getelementptr inbounds nuw [[STRUCT_OUTER]], ptr [[TMP23]], i32 0, i32 0
// CHECK-NEXT:    [[LEN81:%.*]] = getelementptr inbounds nuw [[STRUCT_INNER:%.*]], ptr [[HDR]], i32 0, i32 1
...
// CHECK-NEXT:    [[WIDE_PTR_PTR_ADDR83:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP82]], i32 0, i32 0
// CHECK-NEXT:    [[WIDE_PTR_PTR84:%.*]] = load ptr, ptr [[WIDE_PTR_PTR_ADDR83]], align 8
// CHECK-NEXT:    [[WIDE_PTR_UB_ADDR85:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP82]], i32 0, i32 1
// CHECK-NEXT:    [[WIDE_PTR_UB86:%.*]] = load ptr, ptr [[WIDE_PTR_UB_ADDR85]], align 8
// CHECK-NEXT:    [[WIDE_PTR_LB_ADDR87:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP82]], i32 0, i32 2
// CHECK-NEXT:    [[WIDE_PTR_LB88:%.*]] = load ptr, ptr [[WIDE_PTR_LB_ADDR87]], align 8
// CHECK-NEXT:    [[TMP24:%.*]] = load ptr, ptr [[P]], align 8
// CHECK-NEXT:    [[HDR89:%.*]] = getelementptr inbounds nuw [[STRUCT_OUTER]], ptr [[TMP24]], i32 0, i32 0
// CHECK-NEXT:    [[PTR:%.*]] = getelementptr inbounds nuw [[STRUCT_INNER]], ptr [[HDR89]], i32 0, i32 0
...
// CHECK-NEXT:    br i1 [[TMP26]], label %[[BOUNDSCHECK_NOTNULL91:.*]], label %[[BOUNDSCHECK_NULL98:.*]], !annotation [[META3]]
// CHECK:       [[BOUNDSCHECK_NOTNULL91]]:
// CHECK-NEXT:    [[FAM92:%.*]] = getelementptr inbounds nuw [[STRUCT_OUTER]], ptr [[TMP25]], i32 0, i32 1
// CHECK-NEXT:    [[ARRAYDECAY93:%.*]] = getelementptr inbounds [0 x i32], ptr [[FAM92]], i64 0, i64 0
// CHECK-NEXT:    [[HDR94:%.*]] = getelementptr inbounds nuw [[STRUCT_OUTER]], ptr [[TMP25]], i32 0, i32 0
// CHECK-NEXT:    [[LEN95:%.*]] = getelementptr inbounds nuw [[STRUCT_INNER]], ptr [[HDR94]], i32 0, i32 1
...
// CHECK-NEXT:    [[TMP28:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable.0", ptr [[AGG_TEMP90]], i32 0, i32 0
// CHECK-NEXT:    store ptr [[TMP25]], ptr [[TMP28]], align 8
// CHECK-NEXT:    [[TMP29:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable.0", ptr [[AGG_TEMP90]], i32 0, i32 1
// CHECK-NEXT:    store ptr [[ADD_PTR97]], ptr [[TMP29]], align 8
// CHECK-NEXT:    [[TMP30:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable.0", ptr [[AGG_TEMP90]], i32 0, i32 2
// CHECK-NEXT:    store ptr [[TMP25]], ptr [[TMP30]], align 8
// CHECK-NEXT:    br label %[[BOUNDSCHECK_CONT:.*]]
// CHECK:       [[BOUNDSCHECK_NULL98]]:
// CHECK-NEXT:    [[TMP31:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable.0", ptr [[AGG_TEMP90]], i32 0, i32 0
// CHECK-NEXT:    store ptr null, ptr [[TMP31]], align 8
// CHECK-NEXT:    [[TMP32:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable.0", ptr [[AGG_TEMP90]], i32 0, i32 1
// CHECK-NEXT:    store ptr null, ptr [[TMP32]], align 8
// CHECK-NEXT:    [[TMP33:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable.0", ptr [[AGG_TEMP90]], i32 0, i32 2
// CHECK-NEXT:    store ptr null, ptr [[TMP33]], align 8
// CHECK-NEXT:    br label %[[BOUNDSCHECK_CONT]]
// CHECK:       [[BOUNDSCHECK_CONT]]:
// CHECK-NEXT:    [[WIDE_PTR_PTR_ADDR99:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable.0", ptr [[AGG_TEMP90]], i32 0, i32 0
// CHECK-NEXT:    [[WIDE_PTR_PTR100:%.*]] = load ptr, ptr [[WIDE_PTR_PTR_ADDR99]], align 8
// CHECK-NEXT:    [[WIDE_PTR_UB_ADDR101:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable.0", ptr [[AGG_TEMP90]], i32 0, i32 1
// CHECK-NEXT:    [[WIDE_PTR_UB102:%.*]] = load ptr, ptr [[WIDE_PTR_UB_ADDR101]], align 8
// CHECK-NEXT:    [[WIDE_PTR_LB_ADDR103:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable.0", ptr [[AGG_TEMP90]], i32 0, i32 2
// CHECK-NEXT:    [[WIDE_PTR_LB104:%.*]] = load ptr, ptr [[WIDE_PTR_LB_ADDR103]], align 8
// CHECK-NEXT:    [[TMP34:%.*]] = icmp ne ptr [[WIDE_PTR_PTR100]], null, !annotation [[META3]]
// CHECK-NEXT:    br i1 [[TMP34]], label %[[BOUNDSCHECK_NOTNULL105:.*]], label %[[BOUNDSCHECK_NULL112:.*]], !annotation [[META3]]
// CHECK:       [[BOUNDSCHECK_NOTNULL105]]:
// CHECK-NEXT:    [[TMP35:%.*]] = getelementptr [[STRUCT_OUTER]], ptr [[WIDE_PTR_PTR100]], i64 1, !annotation [[META11]]
// CHECK-NEXT:    [[TMP36:%.*]] = icmp ule ptr [[TMP35]], [[WIDE_PTR_UB102]], !annotation [[META11]]
// CHECK-NEXT:    br i1 [[TMP36]], label %[[CONT107:.*]], label %[[TRAP106:.*]], {{!prof ![0-9]+}}, !annotation [[META11]]
// CHECK:       [[TRAP106]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR5]], !annotation [[META11]]
// CHECK-NEXT:    unreachable, !annotation [[META11]]
// CHECK:       [[CONT107]]:
// CHECK-NEXT:    [[TMP37:%.*]] = icmp ule ptr [[WIDE_PTR_PTR100]], [[TMP35]], !annotation [[META11]]
// CHECK-NEXT:    br i1 [[TMP37]], label %[[CONT109:.*]], label %[[TRAP108:.*]], {{!prof ![0-9]+}}, !annotation [[META11]]
// CHECK:       [[TRAP108]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR5]], !annotation [[META11]]
// CHECK-NEXT:    unreachable, !annotation [[META11]]
// CHECK:       [[CONT109]]:
// CHECK-NEXT:    [[TMP38:%.*]] = icmp uge ptr [[WIDE_PTR_PTR100]], [[WIDE_PTR_LB104]], !annotation [[META6]]
// CHECK-NEXT:    br i1 [[TMP38]], label %[[CONT111:.*]], label %[[TRAP110:.*]], {{!prof ![0-9]+}}, !annotation [[META6]]
// CHECK:       [[TRAP110]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR5]], !annotation [[META6]]
// CHECK-NEXT:    unreachable, !annotation [[META6]]
// CHECK:       [[CONT111]]:
// CHECK-NEXT:    br label %[[BOUNDSCHECK_NULL112]]
// CHECK:       [[BOUNDSCHECK_NULL112]]:
// CHECK-NEXT:    ret ptr [[WIDE_PTR_PTR100]]
//
...
// CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[AGG_TEMP4]], ptr align 8 [[P2]], i64 24, i1 false)
// CHECK-NEXT:    [[TMP8:%.*]] = load i32, ptr [[LEN_ADDR]], align 4
// CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[AGG_TEMP5]], ptr align 8 [[AGG_TEMP4]], i64 24, i1 false), !annotation [[META1]]
// CHECK-NEXT:    [[WIDE_PTR_PTR_ADDR:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP5]], i32 0, i32 0, !annotation [[META1]]
// CHECK-NEXT:    [[WIDE_PTR_PTR:%.*]] = load ptr, ptr [[WIDE_PTR_PTR_ADDR]], align 8, !annotation [[META1]]
// CHECK-NEXT:    [[WIDE_PTR_UB_ADDR:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP5]], i32 0, i32 1, !annotation [[META1]]
// CHECK-NEXT:    [[WIDE_PTR_UB:%.*]] = load ptr, ptr [[WIDE_PTR_UB_ADDR]], align 8, !annotation [[META1]]
...
// CHECK-NEXT:    [[WIDE_PTR_PTR_ADDR82:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP81]], i32 0, i32 0
// CHECK-NEXT:    [[WIDE_PTR_PTR83:%.*]] = load ptr, ptr [[WIDE_PTR_PTR_ADDR82]], align 8
// CHECK-NEXT:    [[WIDE_PTR_UB_ADDR84:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP81]], i32 0, i32 1
// CHECK-NEXT:    [[WIDE_PTR_UB85:%.*]] = load ptr, ptr [[WIDE_PTR_UB_ADDR84]], align 8
// CHECK-NEXT:    [[WIDE_PTR_LB_ADDR86:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP81]], i32 0, i32 2
...
// CHECK-NEXT:    [[TMP24:%.*]] = load ptr, ptr [[P]], align 8
// CHECK-NEXT:    [[HDR88:%.*]] = getelementptr inbounds nuw [[STRUCT_OUTER]], ptr [[TMP24]], i32 0, i32 0
// CHECK-NEXT:    [[LEN89:%.*]] = getelementptr inbounds nuw [[STRUCT_INNER]], ptr [[HDR88]], i32 0, i32 1
