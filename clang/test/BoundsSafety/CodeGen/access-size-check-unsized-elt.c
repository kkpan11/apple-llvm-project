...
// RUN: %clang_cc1 -O0 -fbounds-safety -fbounds-safety-bringup-missing-checks=access_size -triple arm64-apple-ios -emit-llvm %s -o - | FileCheck --check-prefix ACCESS-SIZE %s
// RUN: %clang_cc1 -O0 -fbounds-safety -fno-bounds-safety-bringup-missing-checks=access_size -triple arm64-apple-ios -emit-llvm %s -o - | FileCheck --check-prefix ACCESS-SIZE %s
#include <ptrcheck.h>
int get_int(void*);
...
// ACCESS-SIZE-LABEL: define void @borked(
