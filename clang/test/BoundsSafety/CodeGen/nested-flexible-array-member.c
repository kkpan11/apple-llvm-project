...
// CHECK-NEXT:    br i1 [[TMP10]], label %[[CONT11:.*]], label %[[TRAP10:.*]], !annotation [[META3]]
// CHECK:       [[TRAP10]]:
...
// CHECK-NEXT:    br i1 [[TMP20]], label %[[CONT38:.*]], label %[[TRAP37:.*]], !annotation [[META3]]
// CHECK:       [[TRAP37]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], !annotation [[META3]]
// CHECK-NEXT:    unreachable, !annotation [[META3]]
// CHECK:       [[CONT38]]:
...
// CHECK-NEXT:    br i1 [[TMP34]], label %[[CONT76:.*]], label %[[TRAP75:.*]], !annotation [[META3]]
// CHECK:       [[TRAP75]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], !annotation [[META3]]
// CHECK-NEXT:    unreachable, !annotation [[META3]]
// CHECK:       [[CONT76]]:
