...
// CHECK-NEXT:    [[TMP0:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[IMPL_BIDI_PTR]], i32 0, i32 0
// CHECK-NEXT:    store ptr null, ptr [[TMP0]], align 8
// CHECK-NEXT:    [[TMP1:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[IMPL_BIDI_PTR]], i32 0, i32 1
// CHECK-NEXT:    store ptr getelementptr inbounds (i32, ptr null, i64 1), ptr [[TMP1]], align 8
// CHECK-NEXT:    [[TMP2:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[IMPL_BIDI_PTR]], i32 0, i32 2
...
// CHECK-NEXT:    [[TMP3:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[IMPL_BIDI_PTR2]], i32 0, i32 0
// CHECK-NEXT:    store ptr null, ptr [[TMP3]], align 8
// CHECK-NEXT:    [[TMP4:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[IMPL_BIDI_PTR2]], i32 0, i32 1
// CHECK-NEXT:    store ptr getelementptr inbounds (i32, ptr null, i64 1), ptr [[TMP4]], align 8
// CHECK-NEXT:    [[TMP5:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[IMPL_BIDI_PTR2]], i32 0, i32 2
