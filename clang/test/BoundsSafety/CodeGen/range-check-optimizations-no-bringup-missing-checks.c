...
// CHECK-NEXT:    [[CMP1:%.*]] = icmp sgt i64 [[LEN]], -1
// CHECK-NEXT:    tail call void @llvm.assume(i1 [[CMP1]])
// CHECK-NEXT:    [[ADD_PTR:%.*]] = getelementptr inbounds i32, ptr [[BUF:%.*]], i64 [[LEN]]
// CHECK-NEXT:    br label [[FOR_BODY:%.*]]
// CHECK:       for.cond.cleanup:
// CHECK-NEXT:    ret void
// CHECK:       for.body:
...
// CHECK-NEXT:    tail call void @llvm.assume(i1 [[CMP1]])
// CHECK-NEXT:    [[ADD_PTR:%.*]] = getelementptr inbounds i32, ptr [[DST]], i64 [[N]]
// CHECK-NEXT:    br label [[FOR_BODY:%.*]]
// CHECK:       for.cond.cleanup:
// CHECK-NEXT:    ret void
// CHECK:       for.body:
...
// CHECK-NEXT:    [[CMP27_NOT:%.*]] = icmp ult i64 [[SUB_PTR_DIV]], [[CONV]], {{!annotation ![0-9]+}}
...
// CHECK-NEXT:    [[ADD_PTR_LE:%.*]] = getelementptr inbounds i32, ptr [[TABLE]], i64 [[IDX_EXT_LE]]
