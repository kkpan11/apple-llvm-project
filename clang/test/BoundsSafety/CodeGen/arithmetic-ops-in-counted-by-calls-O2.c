...
// CHECK-LABEL: define void @returned_buf_ok(
...
// CHECK-LABEL: define void @oob_returned_buf_trap(
...
// CHECK-LABEL: define void @overflow_returned_buf_trap(
...
// CHECK-LABEL: define void @overflow_returned_buf_ok(
...
// CHECK-LABEL: define void @too_big_returned_buf_undef(
...
// CHECK-LABEL: define void @index_overflow_returned_buf_fixme(
// CHECK-SAME: ) local_unnamed_addr #[[ATTR3]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
