...
// RUN: %clang_cc1 -O0 -triple arm64-apple-ios -emit-llvm -x objective-c -fexperimental-bounds-safety-objc -fbounds-safety -fbounds-safety-bringup-missing-checks=compound_literal_init -Wno-bounds-attributes-init-list-side-effect -o - %s | FileCheck %s
...
// CHECK-NEXT:    [[SUB_PTR_LHS_CAST84:%.*]] = ptrtoaddr ptr [[WIDE_PTR_UB76]] to i64, !annotation [[META1]]
// CHECK-NEXT:    [[SUB_PTR_RHS_CAST85:%.*]] = ptrtoaddr ptr [[WIDE_PTR_PTR79]] to i64, !annotation [[META1]]
...
// CHECK-NEXT:    [[TMP6:%.*]] = getelementptr [2 x [[STRUCT_CBON]]], ptr [[ARR]], i64 1
...
// CHECK-NEXT:    [[BUF46:%.*]] = getelementptr inbounds nuw [[STRUCT_CBON]], ptr [[ARRAYINIT_ELEMENT]], i32 0, i32 1
// CHECK-NEXT:    store ptr null, ptr [[BUF46]], align 8
// CHECK-NEXT:    [[TMP15:%.*]] = getelementptr [2 x [[STRUCT_CBON]]], ptr [[ARR]], i64 1
