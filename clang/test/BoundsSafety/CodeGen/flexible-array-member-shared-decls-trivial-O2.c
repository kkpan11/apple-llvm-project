...
// CHECK-NEXT:    store i32 42, ptr getelementptr inbounds (i8, ptr @a, i64 8), align 8, !tbaa [[TBAA8:![0-9]+]]
...
// CHECK-NEXT:    store i32 42, ptr getelementptr inbounds (i8, ptr @a, i64 8), align 8, !tbaa [[TBAA8]]
// CHECK-NEXT:    ret ptr @a
//
...
// CHECK-NEXT:    store i32 20, ptr getelementptr inbounds (i8, ptr @a, i64 8), align 8, !tbaa [[TBAA8]]
// CHECK-NEXT:    ret ptr @a
//
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    store ptr @b, ptr @a, align 16, !tbaa [[TBAA2]]
// CHECK-NEXT:    store i32 16, ptr getelementptr inbounds (i8, ptr @a, i64 8), align 8, !tbaa [[TBAA8]]
// CHECK-NEXT:    ret ptr @a
//
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    store ptr @b, ptr @a, align 16, !tbaa [[TBAA2]]
// CHECK-NEXT:    store i32 15, ptr getelementptr inbounds (i8, ptr @a, i64 8), align 8, !tbaa [[TBAA8]]
