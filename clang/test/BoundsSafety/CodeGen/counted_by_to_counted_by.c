...
// CHECK-NEXT:    [[BUF:%.*]] = getelementptr inbounds [[STRUCT_PACKET]], ptr [[P]], i32 0, i32 0
// CHECK-NEXT:    store ptr null, ptr [[BUF]], align 8, {{!annotation ![0-9]+}}
// CHECK-NEXT:    [[LEN:%.*]] = getelementptr inbounds [[STRUCT_PACKET]], ptr [[P]], i32 0, i32 1
...
// CHECK-NEXT:    [[WIDE_PTR_PTR_ADDR20:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP19]], i32 0, i32 0, {{!annotation ![0-9]+}}
// CHECK-NEXT:    [[WIDE_PTR_PTR21:%.*]] = load ptr, ptr [[WIDE_PTR_PTR_ADDR20]], align 8, {{!annotation ![0-9]+}}
// CHECK-NEXT:    [[WIDE_PTR_UB_ADDR22:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP19]], i32 0, i32 1, {{!annotation ![0-9]+}}
// CHECK-NEXT:    [[WIDE_PTR_UB23:%.*]] = load ptr, ptr [[WIDE_PTR_UB_ADDR22]], align 8, {{!annotation ![0-9]+}}
// CHECK-NEXT:    [[WIDE_PTR_LB_ADDR24:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP19]], i32 0, i32 2, {{!annotation ![0-9]+}}
...
// CHECK-NEXT:    [[BUF36:%.*]] = getelementptr inbounds [[STRUCT_PACKET]], ptr [[P]], i32 0, i32 0
// CHECK-NEXT:    store ptr [[WIDE_PTR_PTR31]], ptr [[BUF36]], align 8
// CHECK-NEXT:    [[LEN37:%.*]] = getelementptr inbounds [[STRUCT_PACKET]], ptr [[P]], i32 0, i32 1
