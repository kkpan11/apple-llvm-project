...
// OPT2:       [[TRAP]]:
// OPT2-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3:[0-9]+]], !annotation [[META14]]
// OPT2-NEXT:    unreachable, !annotation [[META14]]
// OPT2:       [[CONT]]:
// OPT2-NEXT:    [[TMP3:%.*]] = icmp ule ptr [[ARRAYIDX]], [[TMP1]], !annotation [[META14]]
// OPT2-NEXT:    br i1 [[TMP3]], label %[[CONT2:.*]], label %[[TRAP1:.*]], !prof [[PROF15]], !annotation [[META14]]
// OPT2:       [[TRAP1]]:
...
// OPT2-NEXT:    br i1 [[TMP4]], label %[[CONT4:.*]], label %[[TRAP3:.*]], !prof [[PROF15]], !annotation [[META16]]
// OPT2:       [[TRAP3]]:
// OPT2-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], !annotation [[META16]]
...
// OPT2: [[META16]] = !{!"bounds-safety-check-ptr-ge-lower-bound"}
//.
