...
// CHECK-LABEL: define void @good_fit(
...
// CHECK-LABEL: define void @good_fit2(
...
// CHECK-LABEL: define void @good_shrink(
// CHECK-SAME: ptr nofree noundef readnone captures(none) [[S:%.*]]) local_unnamed_addr #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: define void @good_zero(
// CHECK-SAME: ptr nofree noundef readnone captures(none) [[S:%.*]]) local_unnamed_addr #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: define void @trap_access_to_count_zero(
...
// CHECK-LABEL: define void @trap_negative_count(
// CHECK-SAME: ptr nofree noundef readnone captures(none) [[S:%.*]]) local_unnamed_addr #[[ATTR2]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
