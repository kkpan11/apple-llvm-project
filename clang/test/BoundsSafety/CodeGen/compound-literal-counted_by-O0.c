...
// CHECK-NEXT:    [[SUB_PTR_LHS_CAST68:%.*]] = ptrtoint ptr [[WIDE_PTR_UB60]] to i64, !annotation [[META1]]
// CHECK-NEXT:    [[SUB_PTR_RHS_CAST69:%.*]] = ptrtoint ptr [[WIDE_PTR_PTR63]] to i64, !annotation [[META1]]
