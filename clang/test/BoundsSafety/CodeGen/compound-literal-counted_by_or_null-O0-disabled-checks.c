...
// RUN: %clang_cc1 -O0 -triple arm64-apple-ios -emit-llvm -x objective-c -fexperimental-bounds-safety-objc -fbounds-safety -fno-bounds-safety-bringup-missing-checks=compound_literal_init -Wno-bounds-attributes-init-list-side-effect -o - %s | FileCheck %s
...
// CHECK-NEXT:    [[TMP3:%.*]] = getelementptr [2 x [[STRUCT_CBON]]], ptr [[ARR]], i64 1
...
// CHECK-NEXT:    [[BUF2:%.*]] = getelementptr inbounds nuw [[STRUCT_CBON]], ptr [[ARRAYINIT_ELEMENT]], i32 0, i32 1
// CHECK-NEXT:    store ptr null, ptr [[BUF2]], align 8
// CHECK-NEXT:    [[TMP12:%.*]] = getelementptr [2 x [[STRUCT_CBON]]], ptr [[ARR]], i64 1
