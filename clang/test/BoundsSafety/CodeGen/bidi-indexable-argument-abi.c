...
// AARCH64-SAME: ptr dead_on_unwind noalias writable sret(%"__bounds_safety::wide_ptr.bidi_indexable") align 8 [[AGG_RESULT:%.*]], ptr nofree noundef align 8 dead_on_return dereferenceable(24) [[PTRARG:%.*]]) #[[ATTR0:[0-9]+]] {
// AARCH64-NEXT:  [[ENTRY:.*:]]
