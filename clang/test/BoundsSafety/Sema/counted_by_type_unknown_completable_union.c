...
typedef union incomplete_union incomplete_union_t; // expected-note 2{{forward declaration of 'union incomplete_union'}}
...
union incomplete_union* __counted_by_or_null(global_union_len) GlobalCBONUnionPtrImplicitInit;
