...
// CHECK: @__a_block_invoke.ptrauth = private constant { ptr, i32, i64, i64 } { ptr @__a_block_invoke, i32 0, i64 ptrtoint (ptr getelementptr inbounds (i8, ptr @__block_literal_global, i64 16) to i64), i64 0 }, section "llvm.ptrauth"
...
// CHECK: @"[[BLOCK_DESCRIPTOR_NAME]].ptrauth" = private constant { ptr, i32, i64, i64 } { ptr @"[[BLOCK_DESCRIPTOR_NAME]]", i32 2, i64 ptrtoint (ptr getelementptr inbounds (i8, ptr @__block_literal_global, i64 24) to i64), i64 49339 }
...
// NODESCRIPTORAUTH: @__a_block_invoke.ptrauth = private constant { ptr, i32, i64, i64 } { ptr @__a_block_invoke, i32 0, i64 ptrtoint (ptr getelementptr inbounds (i8, ptr @__block_literal_global, i64 16) to i64), i64 0 }, section "llvm.ptrauth"
