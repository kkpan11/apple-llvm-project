...
// RUN: %clang_cc1 -O2 -fbounds-safety -emit-llvm -triple arm64e-apple-ios %s -o - | FileCheck %s
// RUN: %clang_cc1 -O2 -fbounds-safety -x objective-c -fexperimental-bounds-safety-objc -emit-llvm -triple arm64e-apple-ios %s -o - | FileCheck %s
...
// CHECK-LABEL: define noundef ptr @addrof_single_ptr_to_single(
// CHECK-SAME: ptr nofree noundef readnone returned captures(ret: address, provenance) [[F:%.*]]) local_unnamed_addr #[[ATTR0:[0-9]+]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
...
// CHECK-LABEL: define nonnull ptr @addrof_single_i_to_single(
// CHECK-SAME: ptr nofree noundef readnone captures(ret: address, provenance) [[F:%.*]]) local_unnamed_addr #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
...
// CHECK-LABEL: define nonnull ptr @addrof_single_l_to_single(
// CHECK-SAME: ptr nofree noundef readnone captures(ret: address, provenance) [[F:%.*]]) local_unnamed_addr #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
...
// CHECK-LABEL: define noalias noundef nonnull ptr @addrof_bidi_ptr_to_single(
...
// CHECK-LABEL: define noalias noundef nonnull ptr @addrof_bidi_ptr_to_single_oob_upper(
...
// CHECK-NEXT:    br i1 [[OR_COND_I]], label %[[__ADDROF_BIDI_PTR_TO_SINGLE_EXIT:.*]], label %[[TRAP_I:.*]], {{!prof ![0-9]+}}, {{!annotation ![0-9]+}}
// CHECK:       [[TRAP_I]]:
...
// CHECK-LABEL: define noalias nonnull ptr @addrof_bidi_i_to_single(
// CHECK-SAME: ) local_unnamed_addr #[[ATTR0]] {
...
// CHECK-LABEL: define noalias noundef nonnull ptr @addrof_bidi_i_to_single_oob_upper(
...
// CHECK-NEXT:    [[TMP2:%.*]] = icmp uge ptr [[BOUND_PTR_ARITH]], [[F]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    [[OR_COND_I:%.*]] = and i1 [[TMP1]], [[TMP2]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[OR_COND_I]], label %[[__ADDROF_BIDI_I_TO_SINGLE_EXIT:.*]], label %[[TRAP_I:.*]], {{!prof ![0-9]+}}, {{!annotation ![0-9]+}}
// CHECK:       [[TRAP_I]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR5]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
...
// CHECK-LABEL: define noalias nonnull ptr @addrof_bidi_l_to_single(
// CHECK-SAME: ) local_unnamed_addr #[[ATTR0]] {
...
// CHECK-LABEL: define noalias noundef nonnull ptr @addrof_bidi_l_to_single_oob_upper(
// CHECK-SAME: ) local_unnamed_addr #[[ATTR3]] {
// CHECK-NEXT:  [[TRAP_I:.*:]]
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) #[[ATTR5]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
...
// CHECK-NEXT:    [[TMP2:%.*]] = icmp uge ptr [[BOUND_PTR_ARITH]], [[F]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    [[OR_COND_I:%.*]] = and i1 [[TMP1]], [[TMP2]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[OR_COND_I]], label %[[__ADDROF_BIDI_L_TO_SINGLE_EXIT:.*]], label %[[TRAP_I:.*]], {{!prof ![0-9]+}}, {{!annotation ![0-9]+}}
// CHECK:       [[TRAP_I]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR5]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
