...
// CHECK-LABEL: define dso_local void @wide_array_subscript(
// CHECK-SAME: [2 x i64] noundef [[BUF_COERCE:%.*]], i32 noundef [[I:%.*]]) #[[ATTR0:[0-9]+]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
...
// CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr %"__bounds_safety::wide_ptr.indexable.0", ptr [[WIDE_PTR_PTR3]], i64 [[IDXPROM]]
...
// CHECK-NEXT:    [[TMP4:%.*]] = icmp ult ptr [[ARRAYIDX]], [[WIDE_PTR_UB5]], {{!annotation ![0-9]+}}
...
// CHECK:       [[CONT]]:
// CHECK-NEXT:    [[TMP5:%.*]] = icmp uge ptr [[ARRAYIDX]], [[WIDE_PTR_LB]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[TMP5]], label %[[CONT7:.*]], label %[[TRAP6:.*]], {{!prof ![0-9]+}}, {{!annotation ![0-9]+}}
// CHECK:       [[TRAP6]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT7]]:
// CHECK-NEXT:    call void @llvm.memset.p0.i64(ptr align 8 [[ARRAYIDX]], i8 0, i64 16, i1 false)
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: define dso_local void @wide_array_subscript_load(
// CHECK-SAME: [2 x i64] noundef [[BUF_COERCE:%.*]], i32 noundef [[I:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[BUF:%.*]] = alloca %"__bounds_safety::wide_ptr.indexable", align 8
// CHECK-NEXT:    [[I_ADDR:%.*]] = alloca i32, align 4
// CHECK-NEXT:    [[AGG_TEMP:%.*]] = alloca %"__bounds_safety::wide_ptr.bidi_indexable", align 8
...
// CHECK-LABEL: define dso_local void @wide_array_subscript_addr(
// CHECK-SAME: [2 x i64] noundef [[BUF_COERCE:%.*]], i32 noundef [[I:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[BUF:%.*]] = alloca %"__bounds_safety::wide_ptr.indexable", align 8
// CHECK-NEXT:    [[I_ADDR:%.*]] = alloca i32, align 4
...
// CHECK-LABEL: define dso_local void @wide_deref(
// CHECK-SAME: [2 x i64] noundef [[BUF_COERCE:%.*]], i32 noundef [[I:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[BUF:%.*]] = alloca %"__bounds_safety::wide_ptr.indexable", align 8
// CHECK-NEXT:    [[I_ADDR:%.*]] = alloca i32, align 4
...
// CHECK-NEXT:    br i1 [[TMP14]], label %[[CONT7:.*]], label %[[TRAP6:.*]], {{!prof ![0-9]+}}, {{!annotation ![0-9]+}}
// CHECK:       [[TRAP6]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT7]]:
...
// CHECK-SAME: ptr nofreeobj noundef align 8 dead_on_return dereferenceable(24) [[W:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
