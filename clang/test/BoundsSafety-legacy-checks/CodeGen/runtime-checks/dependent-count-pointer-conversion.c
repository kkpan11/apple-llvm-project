...
// O0-NEXT:    [[SUB_PTR_LHS_CAST:%.*]] = ptrtoaddr ptr [[WIDE_PTR_UB]] to i64, {{!annotation ![0-9]+}}
// O0-NEXT:    [[SUB_PTR_RHS_CAST:%.*]] = ptrtoaddr ptr [[WIDE_PTR_PTR]] to i64, {{!annotation ![0-9]+}}
...
// O0-NEXT:    br i1 [[TMP4]], label %[[CONT:.*]], label %[[TRAP:.*]], {{!prof ![0-9]+}}, {{!annotation ![0-9]+}}
// O0:       [[TRAP]]:
...
// O0:       [[BOUNDSCHECK_NOTNULL]]:
// O0-NEXT:    [[TMP11:%.*]] = icmp ult ptr [[WIDE_PTR_PTR16]], [[WIDE_PTR_UB18]], {{!annotation ![0-9]+}}
// O0-NEXT:    br i1 [[TMP11]], label %[[CONT22:.*]], label %[[TRAP21:.*]], {{!prof ![0-9]+}}, {{!annotation ![0-9]+}}
// O0:       [[TRAP21]]:
...
// O0-NEXT:    br i1 [[TMP12]], label %[[CONT24:.*]], label %[[TRAP23:.*]], {{!prof ![0-9]+}}, {{!annotation ![0-9]+}}
// O0:       [[TRAP23]]:
// O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// O0:       [[CONT24]]:
...
// O0-NEXT:    [[ARRAYIDX:%.*]] = getelementptr i32, ptr [[WIDE_PTR_PTR29]], i64 5
...
// O0-NEXT:    [[TMP18:%.*]] = icmp ult ptr [[ARRAYIDX]], [[WIDE_PTR_UB31]], {{!annotation ![0-9]+}}
// O0-NEXT:    br i1 [[TMP18]], label %[[CONT35:.*]], label %[[TRAP34:.*]], {{!prof ![0-9]+}}, {{!annotation ![0-9]+}}
// O0:       [[TRAP34]]:
// O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// O0:       [[CONT35]]:
// O0-NEXT:    [[TMP19:%.*]] = icmp uge ptr [[ARRAYIDX]], [[WIDE_PTR_LB33]], {{!annotation ![0-9]+}}
// O0-NEXT:    br i1 [[TMP19]], label %[[CONT37:.*]], label %[[TRAP36:.*]], {{!prof ![0-9]+}}, {{!annotation ![0-9]+}}
// O0:       [[TRAP36]]:
// O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// O0:       [[CONT37]]:
// O0-NEXT:    [[TMP20:%.*]] = load i32, ptr [[ARRAYIDX]], align 4
// O0-NEXT:    ret i32 [[TMP20]]
//
// O2-LABEL: define dso_local noundef i32 @main(
