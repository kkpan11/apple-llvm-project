...
void illegal2(intp __ptrauth(ptrauth_key_none, 0, 0)); // expected-error{{parameter type may not be qualified with '__ptrauth'}}
intp __ptrauth(ptrauth_key_none, 0, 0) illegal3(void); // expected-error{{return type may not be qualified with '__ptrauth'}}
