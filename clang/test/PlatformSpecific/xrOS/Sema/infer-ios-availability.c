...
void use() {
  ios_unavail(); // ios-error {{'ios_unavail' is unavailable: not available on visionOS}}
  ios_ext_unavail(); // ext-error {{'ios_ext_unavail' is unavailable: not available on visionOS}}
}
...
void useIntroduced() {
  ...
  ios_introduced_16(); // ios-error {{is unavailable: not available on visionOS}}
  ios_ext_introduced_16(); // ext-error {{is unavailable: not available on visionOS}}
}
...
void useDeprecated() {
  ...
  ios_deprecated_10(); // ios-warning {{is deprecated: first deprecated in visionOS 1.0}}
  ios_ext_deprecated_10(); // ext-warning {{is deprecated: first deprecated in visionOS (App Extension) 1.0}}
  // deprecated iOS 15 => deprecated xrOS 1
  ios_deprecated_15(); // ios-warning {{is deprecated: first deprecated in visionOS 1.0}}
  ios_ext_deprecated_15(); // ext-warning {{is deprecated: first deprecated in visionOS (App Extension) 1.0}}
  // deprecated iOS 16 => deprecated xrOS 1.0.99
  ios_deprecated_16();
#ifdef XROS2
  // ios-warning@-2 {{is deprecated: first deprecated in visionOS 1.0.99}}
#endif
...
void useObsoleted() {
  // deprecated iOS < 10 => deprecated xrOS 1
  ios_obsoleted_10(); // ios-error {{is unavailable: obsoleted in visionOS 1.0}}
  ios_ext_obsoleted_10(); // ext-error {{is unavailable: obsoleted in visionOS (App Extension) 1.0}}
  // deprecated iOS 15 => deprecated xrOS 1
  ios_obsoleted_15(); // ios-error {{is unavailable: obsoleted in visionOS 1.0}}
  ios_ext_obsoleted_15(); // ext-error {{is unavailable: obsoleted in visionOS (App Extension) 1.0}}
  // obsoleted iOS 16 => obsoleted xrOS 1.0.99
  ios_obsoleted_16();
#ifdef XROS2
  // ios-error@-2 {{is unavailable: obsoleted in visionOS 1.0.99}}
#endif
