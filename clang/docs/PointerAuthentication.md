...
[`ptrauth_string_discriminator`](#ptrauth-string-discriminator)) of the mangling of the original overridable
method.
...
same {ref}`C signing schema Objc isa and super <signing-schemas>`.
...
string hash (see [`ptrauth_string_discriminator`](#ptrauth-string-discriminator)) of the mangling of the
...
{ref}`relative addresses <relative-addresses>`.  Type context descriptors are signed with the `DA` key
