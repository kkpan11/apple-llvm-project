...
private:
  ...
  Decl *ParseFunctionDefinition(
      ...
      LateParsedAttrList *LateParsedAttrs =
          nullptr, // TO_UPSTREAM(BoundsSafety)
...
/* TO_UPSTREAM(AvailabilityAttribute) ON*/
...
/* TO_UPSTREAM(AvailabilityAttribute) OFF*/
  ...
  /// \endverbatim
  ///
  void ParseAtomicSpecifier(DeclSpec &DS, // TO_UPSTREAM(BoundsSafety)
                            LateParsedAttrList *LateAttrs = nullptr);
...
public:
  ...
  Decl *ParseFunctionBody(Decl *D, ParseScope &BodyScope,
                          // TO_UPSTREAM(BoundsSafety)
                          Declarator *FnDeclarator = nullptr,
                          LateParsedAttrList *BoundsSafetyLateAttrs = nullptr);
