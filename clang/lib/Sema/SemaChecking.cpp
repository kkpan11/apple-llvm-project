...
bool Sema::ValidateFormatString(FormatStringType Type,
  ...
  // positional arguments are used multiple times (such as %2$i %2$d), all
  // uses are mutually compatible. As an optimization, don't test the first
  // member against itself.
  bool HadError = false;
